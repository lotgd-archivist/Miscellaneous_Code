...
if ($_GET[op]=="lasthit"){
    ...
    if ($_GET[userid]==getsetting("hasegg",0)) savesetting("hasegg",addslashes(0));
    ...
    output("<input type='radio' value='ip' name='type' checked> IP: <input name='ip' value=\"".htmlentities_charset_charset($row[lastip])."\">`n",true);
    output("<input type='radio' value='id' name='type'> ID: <input name='id' value=\"".htmlentities_charset_charset($row[uniqueid])."\">`n",true);
