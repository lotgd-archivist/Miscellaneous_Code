...
addnav ("Blumenmädchen" , "blumenmaedchen.php");
addnav("Ruhmeshalle","hof.php");

addnav("Marktplatz");
//addnav ("Markt" , "marktplatz.php");
...
addnav ("Ausbildung","ausbildung.php");
...
addnav("E?Verlassenes Schloss","abandoncastle.php"); 
addnav("Alchemistin","alchemistin.php");
//addnav("B?Versteckte Bucht", "versteckte-bucht.php");
...
addnav("Spiel-Forum","http://logd-forum.zumhexenkessel.de/",false,false,true);
