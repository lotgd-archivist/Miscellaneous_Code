...
case "pickfruit":
    ...
    output("`n`n`9Du versuchst etwas vom `$ Baum des Todes `9zu nehmen und findest....`n`n");
        ...
        case 2:
            ...
            break;
        case 3:
            output("`^ einen gefallenen Engel, welcher zwischen zwei Ästen feststeckt. Hilfsbereit une Ehrenhaft wie du bist, befreist du den gefallenen Engel mit ein paar geschickten Handgriffen und er ist dir für deine ruhmvolle Tat sehr dankbar. `n`nEr schwingt seinen Stab und du stellst fest, dass dich diese Tat noch `1$charmanter `^ gemacht hat!");
        ...
        case 6:
            ...
            break;
            case 8:
            output("`^ Ramius der auf dem Baum sitzt und genüsslich eine Drachenfrucht verschlingt!!!`n`n");
      ...
      case 12:
          ...
          break;
          case 13:
           output("`^ auf den ersten Blick nichts, was dich dazu verleitet den Baum hhhochzuklettern und weiter und weiter und weiter, bis du den obersten Ast des Baumes erreichst. Dort findest du eine pechschwarze Frucht, welche dir ein paar `$Seelenpunkte `^bringt!");
