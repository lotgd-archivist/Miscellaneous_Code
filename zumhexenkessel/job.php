...
addnav ("Das Arbeitsamt verlassen","village.php");
...
output ("`&Du fragst die junge Frau an der Rezeption nach einem Berater, der dir in deiner mieserablen Lage weiter helfen kann , sie blickt kurz in die Unterlagen und vergleicht sie mit deinen Angaben über deine Ausbildung und deine Noten, ein Grinsen huscht über ihr Gesicht, als sie deine Beste Note sieht.`n");
...
//Um Spieler kurz vor dem Drachenkill zum Dreachenkill zu zwingen
...
output ("
`6`bJeder Krieger in Ocasia kann einen Job ergreifen, doch dazu muss er die Passenden Qualifikationen haben, diese kann er in der Universität bekommen. `n
...
als kochendes Wasser ein Ei.`c");    
    ...
    output ("`c`^Rache ist süß, doch vergeben wie ein Brot mit Honig`c");
                break;
            case 6:
    output ("`c`^Den grünen Drachen zu besiegen, ist wahrlich eine Leistung`c");
                break;
            case 7:
