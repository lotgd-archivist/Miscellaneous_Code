...
    addnav("Rangliste","heldengasse_ruhmeshalle.php?op=battlepoints&subop=most");
    addnav("Zurück zur Arena","heldengasse_pvparena.php");
}
if ($_GET[op] == "lounge"){
...
                break;
                case 15:
                output("`#Ein Fan rennt in die Arena, doch im Eifer des Gefechts streifst du ihn und er fliegt in eine Ecke der Arena.`n");
                break;
                }
/*
                output("`6Moderator: ");
