...
    addnews("`&".$session[user][name]."`7 rettete ".($session[user][sex]?"einen Prinzen":"eine Prinzessin")." aus `r $loc `7!`0");
            switch (e_rand(1, 5)) {
                case 1:
...
                    break;
                case 3:
                    output("".($session[user][sex]?"Er":"Sie")." hat dir Dinge gezeigt, von denen du nicht einmal zu träumen gewagt hast.`n`n");
...
        case 5:
            output("`3Schließlich öffnest du etwas, das wie eine Tür aussieht und entdeckst eine gut eingerichtete Kammer. `n`n");
            output("Die Kammer enthält eine große Truhe, aus der gedämpfte Hilferufe kommen. Du reisst die Truhe auf  ");
...
        case 6:
            output("`3Schließlich öffnest du etwas, das wie eine Tür aussieht und entdeckst eine gut eingerichtete Kammer. `n`n");
            output("In der Kammer steht ein ".($session[user][sex]?"runzeliger alter Mann":"runzeliges altes Weib")."!  Du schnappst vor Abscheu vor diesem fürchterlichen Ding vor dir nach Luft ");
            output(", bevor du laut schreiend davon rennst. Irgendwie hast du das Gefühl, ");
...
            output("möglich aus dem Staub. Glücklicherweise hat außer deinem Stolz sonst nichts Schaden genommen.`n`n");
            break;
        case 8:
            output("`3Eine heiße Schlacht entbrennt und du bringst einiges an Mühe auf! Unglücklicherweise bist du hoffnungslos ");
...
            addnews("`&".$session[user][name]."`7 starb beim Versuch, ".($session[user][sex]?"einen Prinzen":"eine Prinzessin")." aus`r $loc `7zu befreien.`0");
...
            output("du musst für alle entstandenen Schäden aufkommen.`n`n");
