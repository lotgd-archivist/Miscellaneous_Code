...
    output("Du fasst in den hohlen Baum und ");
...
        break;
        case 3:
        output("streifst dabei einen der `2weißen Pilze`7, der daraufhin mit einem leisen 'Plopp!' eine riesige Menge Sporen auspustet, die Du unglücklicherweise einatmest! Ausgestreckt auf dem Baum liegend siehst du grelle Farben und hörst leise Musik während die Zaubersporen deine Erinnerungen vernichten und du dich beim Aufwachen fragst, wie du hier hergekommen bist.`n`n");
...
        addnews("`jIn einer stürmischen Nacht findet `& ".$session['user']['name']." `jeinen riesigen Schatz von `9$foundgold`0 Goldstücken.`0");
