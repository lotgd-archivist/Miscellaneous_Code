...
        output("dass du gar keinen Edelstein hast. Die kleine Fee schwebt vor dir, die Arme in die Hüfte gestemmt und mit dem Fuß in der Luft klopfend, ");
...
        output("so viel Zeit, um den Weg zurück ins Dorf zu finden, dass du einen ganzen Waldkampf verlierst.");
        $session['user']['turns']--;
    }
}else{
  output("`%Du willst dich nicht von einem deiner kostbaren Edelsteine trennen und lässt die kleine Fee einfach stehen.");
    output("Ihr Geschimpfe verfolgt dich noch eine ganze Weile, aber das stört dich kein bisschen.");
}
