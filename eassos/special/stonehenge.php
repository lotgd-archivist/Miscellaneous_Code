...
    output(" du hast eigentlich nie geglaubt, dass er wirklich existiert. Sie sagen, der Kreis hat große magische ");
...
        output("deinen Füßen in einem schwachen Licht lila zu glühen scheint, fast so, als ob sich der Boden selbst in Nebel ");
...
                addnews("`&".$session[user][name]." `7ist für eine Weile verschwunden und jene, welche gesucht haben, kommen nicht zurück.");
                break;
            case 3:
...
                $session[user][gold] = 0;
                addnav("Tägliche News","news.php");
                addnews("`&".$session[user][name]."'s `7lebloser Körper wurde auf einer leeren Lichtung gefunden.");
                break;
            case 4:
            case 5:
            case 6:
...
            case 19:
            case 20:
              output("fühlst du deine Ausdauer in die Höhe schießen!");
...
                output("Das Ergebnis ist, dass du $lostTurns Waldkämpfe verlierst!");                
                break;
        }
    }else{
