...
            output("`9\"`!Sei gegrÃ¼sst!`9\", spricht dich eine alte Seele an, die schon seit Ewigkeiten hier zu sein scheint, \"`!Ich bin `4Hatetepe`!, ");

            output("der tote HÃ¤ndler, der nie gestorben ist, immer auf dem Sprung und schon ewig hier. Ich tausche hier meine Waren, die mir nie gehÃ¶rten. Sie bringen dir sowohl im Totenreich, wie auch");

            output(" im Reich der Lebenden einen Vorteil, der keiner ist. Also, kann ich dir materiellen oder spirituellen Besitz anbieten oder abknÃ¶pfen?`9\"");
...
            output("`9Du entdeckst eine MÃ¶glichkeit, mit der Welt der Lebenden in Verbindung zu treten! Allerdings wird dich dieses Unternehmen einiges ");

            output("an Gefallen kosten und wer und ob dich jemand hÃ¶ren wird, wissen nicht einmal die GÃ¶tter.");
...
        output("`9Du bemerkst einen seltsamen Schimmer und wandelst darauf zu.`nDu hast den `bFluss der Seelen`b gefunden! Jenen merkwÃ¼rdigen Ort, ");

        output("der angeblich das Reich der Toten und die Welt der Lebenden verbindet und wo all die toten Kreaturen herkommen, die einst den Wald und jetzt den Friedhof bevÃ¶lkern. Du witterst eine Chance, dem Totenreich zu entfliehen, aber du weiÃŸt auch um die ");

        output("Gefahren einer solchen Unternehmung bescheid.`n`nWirst du den Fluchtversuch wagen? Oder willst du diesen sagenhaft Ort nÃ¤her untersuchen?");
