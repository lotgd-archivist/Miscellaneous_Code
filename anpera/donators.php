...
output("`bDonationpoints vergeben:`b`nCharakter: <input name='name'> `nPunkte: <input name='amt' size='3'>`n<input type='submit' class='button' value='Donation hinzuf&uuml;gen'>",true);
...
    output("BestÃ¤tige {$_POST['amt']} Punkte an:`n`n");
