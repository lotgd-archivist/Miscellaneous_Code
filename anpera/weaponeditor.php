...
        output("<td>[<a href='weaponeditor.php?op=edit&id=$row[weaponid]&level=$weaponlevel'>Edit</a>|<a href='weaponeditor.php?op=del&id=$row[weaponid]&level=$weaponlevel' onClick='return confirm(\"Diese Waffe wirklich lÃ¶schen?\");'>L&ouml;schen</a>]</td>",true);
