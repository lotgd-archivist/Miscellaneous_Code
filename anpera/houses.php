...
        output("<table cellspacing=0 cellpadding=2 align='center'><tr><td>`bHausNr.`b</td><td>`bName`b</td><td>`bEigent&uuml;mer`b</td></tr>",true);
...
              output("<tr><td colspan=4 align='center'>`&`iEs gibt momentan keine bewohnten H&auml;user`i`0</td></tr>",true);
...
              output("<tr><td colspan=4 align='center'>`&`iEs stehen momentan keine H&auml;user zum Verkauf`i`0</td></tr>",true);
...
        output("`n`n`n<table border='0'><tr><td>`2`bDie Schl&uuml;ssel:`b `0</td><td>`2`bExtra Ausstattung`b</td></tr><tr><td valign='top'>",true);
...
    output("<table cellpadding=2 cellspacing=1 bgcolor='#999999' align='center'><tr class='trhead'><td>`bHausNr.`b</td><td>`bName`b</td><td>`bEigent&uuml;mer`b</td><td>`bStatus`b</td></tr>",true);
...
          output("<tr><td colspan=4 align='center'>`&`iEs gibt noch keine H&auml;user`i`0</td></tr>",true);
