...
        output("`6Du verlierst deine Waffe, deine RÃ¼stung und dein gesamtes Inventar.`n");

        output("`6Du vergisst deine Rasse und alle besonderen FÃ¤higkeiten.`n");
...
        output("diesen Schritt gut Ã¼berlegt hast. Du wirst `beiniges`b verlieren, wenn du fortfÃ¤hrst. Du wirst zu:`n`n");
...
        output("<input type='submit' class='button' value='Charakter zurÃ¼cksetzen' onClick='return confirm(\"Willst du die Werte deines Charakters wirklich neu verteilen?\");'>", true);
...
        $session[user][lasthit]=date("Y-m-d H:i:s",strtotime(date("Y-m-d H:i:s")."-".(86500/getsetting("daysperday",4))." seconds"));

        output("`n`6Du stimmst zu.`nWÃ¤hrend du das Ritual durchfÃ¼hrst und dich von deinem Besitz lÃ¶st, spÃ¼rst du auch deine Lebenkraft, deine Erfahrung und schlieÃŸlich all deine FÃ¤higkeiten ");

        output("schwinden. Du vergisst dein ganzes bisheriges Leben. Du fÃ¤llst in eine lange Ohnmacht...");
...
        output("`n`6Du stimmst zu.`nWÃ¤hrend du das Ritual durchfÃ¼hrst und dich von deinem Besitz lÃ¶st, spÃ¼rst du auch deine Lebenkraft und all deine FÃ¤higkeiten ");

        output("schwinden. Du vergisst vieles aus deinem bisherigen Leben und fÃ¤llst in eine lange Ohnmacht...");
...
        output("Wie von selbst Ã¶ffnet sich die TÃ¼r. Dahinter siehst du einen mÃ¤chtigen Altar der GÃ¶tter. Du spÃ¼rst fÃ¶rmlich, dass sich hier dein Leben grundlegend Ã¤ndern kann.");

        output(" Eine Tafel vor dem Altar bestÃ¤tigt dieses GefÃ¼hl: \"`4Hier kannst du die Fehler deiner Vergangenheit rÃ¼ckgÃ¤ngig machen und um einen Neuanfang bitten. Wisse aber, dass diese ");

        output("Entscheidung dazu die letzte deines Lebens darstellt. Du wirst morgen ohne deine weltlichen GÃ¼ter und ohne Erinnerung auf dem Dorfplatz aufwachen. Nur mit ");

        output(" Chance ausgerÃ¼stet, es noch einmal besser zu machen.`6\"`n`nWillst du neu beginnen?`n`n");

        output("`bVollstÃ¤ndige Wiedergeburt:`b`n");

        output("Du wÃ¼rdest wieder als ".($session[user][sex]?"BauernmÃ¤dchen":"Bauernjunge")." mit nichts als den gesammelten Donationpoints im Dorf aufwachen. Dein Leben ");

        output("wÃ¼rde beendet und im selben Moment von vorne beginnen.`n`\$Diese Option ist fÃ¼r Krieger gedacht, die bereits alles erreicht haben, ");
...
        output("Drachenkills, Titel, Ehepartner und deine Erinnerung bleiben dir erhalten, jedoch legst du alle anderen weltlichen BesitztÃ¼mer ab und wirst es sehr schwer haben, dich wieder ");

        output(" an das knallharte Leben mit dem Drachen zu gewÃ¶hnen. DafÃ¼r kannst du alle Drachenpunkte neu vergeben.");



    }else{

        output("Doch alle Versuche, diese TÃ¼r zu Ã¶ffnen, schlagen fehl. Du erkundigst dich im Club nach dieser TÃ¼r und bekommst tatsÃ¤chlich eine Antwort: \"`4");

        output("Hinter dieser TÃ¼r steht ein mÃ¤chtiger Altar der GÃ¶tter. Es ist ein Altar des Vergesssens, des Todes und der Erneuerung. Nur sehr mÃ¤chtigen Kriegern ");

        output("ist es gestattet, diesen Altar zu benutzen. Dort kÃ¶nnen sie Ã¼ber ihr bisheriges Leben nachdenken und um einen Neuanfang bitten. Du wirst noch ");
