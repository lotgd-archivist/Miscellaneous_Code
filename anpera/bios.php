...
    systemmail($_GET['userid'],"Deine Kurzbeschreibung wurde gesperrt","Der Administrator hat beschlossen, dass deine Kurzbeschreibung unangebracht ist und hat sie gesperrt.`n`nWenn du darÃ¼ber diskutieren willst, benutze bitte den Link zur Hilfeanfrage.");
    db_query($sql);
}
...
    if ($row['biotime']>$session['user']['recentcomments']) output("<img src='images/new.gif' alt='&gt;' width='3' height='5' align='absmiddle'> ",true);
