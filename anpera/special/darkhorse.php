...
                $sql = "SELECT acctid,name,alive,location,maxhitpoints,gold,sex,level,weapon,armor,attack,defence,race,charm FROM accounts WHERE login='".addslashes(stripslashes($_GET['who']))."'";
...
                    elseif ($amt-10>$row['charm']) { output("`bviel`b hÃ¤schlicher alsch du!`n");}

                    elseif ($amt>$row['charm']) { output("hÃ¤schlicher alsch du.`n");}

                    elseif ($amt+10<$row['charm']) { output("`bviel`b schÃ¶ner alsch du!`n");}
...
                output("`4`bName:`b`6 Ohnemos Nixlos`n");
