...
    output("`@Sprosse fÃ¼r Sprosse erklimmst Du den Baum und stehst bald auf einer Art Plattform, wo Dich ein hagerer `2Elf`@ - der ein braunes Gewand trÃ¤gt und seine `6goldblonden Haare`@ zu einem Pferdeschwanz nach hinten gebunden hat - begrÃ¼ÃŸt.`n");
...
            output("`@Der Elf nimmt all Dein Gold und spricht einen Zauber darÃ¼ber. Es verwandelt sich...`n`n");

            output("`6in ein wunderschÃ¶nes `&Etwas `6was Du leider nicht identifizieren kannst. Aber schÃ¶n ist es. Irgendwie.");

            output("`n`n`@Du nimmst das Gebilde und staunst eine Weile darÃ¼ber. Dann steckst Du es ein. Vielleicht gibt Dir ja ein HÃ¤ndler was dafÃ¼r...");
