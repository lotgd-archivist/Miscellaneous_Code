...
output("an der dir viele BÃ¼sche den Weg erschweren.`n");
...
        output("`2Doch bevor du dich darum kÃ¼mmern kannst, ihn festzuhalten, ist er dir auch schon abgerissen und hoffnungslos im Dickicht verloren.`n`n`0");
...
        output("`2Gerade rechtzeitig genug bemerkst du, wie sich dein Goldbeutel schon etwas gelÃ¶st hat.`n");

        output("Hastig machst du ihn wieder fest und bei deinem weiteren Weg hÃ¤ltst du ihn aufmerksam fest.`n`n`0");
...
        output("Als du deinen Weg fortsetzen willst, entdeckst du einen Goldbeutel im GebÃ¼sch hÃ¤ngen.");

        output("Du muÃŸt einiges an Kraft aufbringen, um den Beutel aus dem GebÃ¼sch zu befreien.`n`n`0");
...
            output("`2Da hat aber jemand mehr GlÃ¼ck gehabt, als Verstand.`0`n");

        } else {

            output("`6Als du den Goldbeutel aufmachst, zÃ¤hlst du `$ $gold_lost `6GoldstÃ¼cke, die nun dein sind.`n`n`0");
