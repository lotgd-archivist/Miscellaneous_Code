...
    output("`n`2Als du den Baum nÃ¤her untersuchst, merkst du, dass der Baum innen hohl ist. ");

    output("Du faÃŸt in den hohlen Baum und ");
...
        addnav("ZurÃ¼ck in den Wald","forest.php?op=back");
...
        output("du streifst dabei einen der `2weissen Pilze`7, der daraufhin mit einem leisen 'Plopp!' eine riesige Menge Sporen auspustet, die Du unglÃ¼cklicherweise einatmest! Ausgestreckt auf dem Baum liegend siehst du grelle Farben und hÃ¶rst leise Musik wÃ¤hrend die Zaubersporen deine Erinnerungen vernichten und du dich beim Aufwachen fragst, wie du hier hergekommen bist.`n`n");
...
        output("spÃ¼rst einen brennenden Schmerz in deiner Hand! Eine Schlange bewohnt diesen Baumstamm und hat dir in die Hand gebissen. Dir ");

        output("wird schwarz vor Augen. Das Gift wirkt.`n`nAls du wieder zu dir kommst, fÃ¼hlst du dich schwach. Aber du hast Ã¼berlebt.`n");
...
        output("du fasst direkt mitten in ein `4Wespennest! `7Zornig aufgeweckt stÃ¼rzen sich die Wespen wutentbrannt auf dich und zerstechen Deine Arme, Dein Gesicht und Deinen Hals!`n`n");
...
    output("Am markierten Weg erkennst du, dass dich die Schatzsuche fast den gesamten restlichen Tag kosten wÃ¼rde.");
...
        output("`n`2Leider hast du heute nicht mehr genug Zeit Ã¼brig, die du zum Suchen nach dem Schatz verwenden kÃ¶nntest.");

    }else{

        $runden=e_rand(1,$session[user][turns]);

        output("`n`2Auf der Suche nach dem `4X`2 auf der Karte verbrauchst du `@$runden `2WaldkÃ¤mpfe. Schliesslich findest du die Stelle ");

        output("und fÃ¤ngst auch sofort an, mit ".$session[user][weapon]."`2 nach dem hier vermuteten Schatz zu graben. ");

        output("Schon nach kurzer Zeit stÃ¶ÃŸt du auf eine groÃŸe beschlagene ");

        output("Holzkiste. Als du die Kiste Ã¶ffnest, lÃ¤chelt dich ein kleines VermÃ¶gen an:`n`n");
...
        output("`2In der Schatztruhe findest du $foundgold GoldstÃ¼cke. Nach einem kleinen Freudentanz machst du dich zurÃ¼ck auf deinen Weg.");

        addnews("`0In einer stÃ¼rmischen Nacht findet ".$session['user']['name']." einen riesigen Schatz von `^$foundgold`0 GoldstÃ¼cken.");
...
    output("`2Am Rande des Weges fÃ¤llt dir ein umgefallener hohler Baum auf, der irgendwie nach einem Abenteuer riecht.`n`n");

    output("Du kannst den Baum nÃ¤her untersuchen oder weiter deines Weges gehen.`0");
