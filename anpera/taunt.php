...
        output("[<a href='taunt.php?op=edit&tauntid={$row['tauntid']}'>Edit</a>|<a href='taunt.php?op=del&tauntid={$row['tauntid']}' onClick='return confirm(\"Diesen Eintrag wirklich lÃ¶schen?\");'>L&ouml;schen</a>]",true);
