...
`@Nun liegt es an dir!`nWirst du eine Kapsel schlucken oder ist dir das ganze doch etwas zu unheimlich?? "); 
    ...
    addnav("r?Nimm die rote Kapsel","berge.php?op=redcaps"); 
    addnav("g?Nimm die grüne Kapsel","berge.php?op=greencaps"); 
    addnav("l?Nimm die blaue Kapsel","berge.php?op=bluecaps");  //bugfix gargamel 
    addnav("e?Nimm die gelbe Kapsel","berge.php?op=yellowcaps"); 
    addnav("s?Nimm die schwarze Kapsel","berge.php?op=blackcaps"); 
    addnav("w?Nur weg hier","berge.php?op=nocaps"); 
