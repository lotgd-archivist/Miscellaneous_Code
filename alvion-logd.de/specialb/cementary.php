...
if ($session[user][superuser] >= 0) {
    ...
    if($_GET['op'] == '' || $_GET['op']== 'search'){
        ...
        addnav("Grabsteine lesen","berge.php?op=read");
        addnav("Den Friedhof verlassen","berge.php?op=leave");
        ...
        addnav("Grabsteine näher untersuchen","berge.php?op=search2");
        addnav("Den Friedhof verlassen","berge.php?op=leave");
        }
    else if ($_GET[op]=="search2")
        {
        $session[user][specialinc]="cementary.php";
        ...
        if ($suchergebnis < 5)
            ...
            addnav("Grab öffnen","berge.php?op=open");
            }
        ...
        addnav("Den Friedhof verlassen","berge.php?op=leave&grabopen=1");

        }

    else if ($_GET[op]=="leave")
        {
        $grabopen=$GET[grabopen];
        addnav("Weiter","berge.php");
        output("`^Du kehrst wieder in die Berge zurück und lässt den Toten ihre Ruhe.`0");
