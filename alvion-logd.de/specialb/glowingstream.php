...
if ($_GET[op]==""){
  output("`#Du entdeckst einen schmalen Strom schwach glühenden Wassers, das über runde, glatte, weiße Steine blubbert. Du kannst eine magische ");
    ...
    output("`n`n<a href='berge.php?op=drink'>Trinken</a>`n<a href='berge.php?op=nodrink'>Nicht trinken</a>",true);
    addnav("Trinken","berge.php?op=drink");
    addnav("Nicht Trinken","berge.php?op=nodrink");
    addnav("","berge.php?op=drink");
    addnav("","berge.php?op=nodrink");
...
//    $session[user][thirsty]+=2;
      ...
      output("`#Weil du die verhängnisvollen Kräfte in diesem Wasser fürchtest, entschließt du dich, es nicht zu trinken und ziehst weiter durch die Berge.");
    }
}
?>
