...
     output(" `^Du triffst den `b`4Ritter Möchtegern,`b `^der dich mit seiner Kampfaxt angreift,`n");
...
        output(" `^Du beschließt, dass du den `4Ritter Möchtegern `^ein wenig jagst, `n ");
...
                output(" `^Du bist schwer verletzt und stellst fest, dass Rache keine gute Idee ist. `n");
...
                addnews("`&".$session[user][name]."`j wurde vom `9Ritter Möchtegern`j niedergestreckt.");
                break;
            case 5:
...
                output(" Als meine Sinne wieder klar waren, sah ich, dass Du garnicht der Troll bist. Ich schämte mich so sehr,");
                output(" dass ich mich umdrehte und davon lief. Aber das sollte ein Geheimnis zwischen uns bleiben. Ich gebe dir `5$gold Gold ");
