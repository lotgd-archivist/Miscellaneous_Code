...
        }else{
                output("Du spürst einen Ruck an deiner Edelsteinsammlung aber glücklicherweise hast du keine Edelsteine dabei und machst dir darum auch keine Sorgen wegen dem Äffchen, das scheinbar enttäuscht zurück in den Bergwald läuft.`0");
...
      output("Du kehrst in den Wald zurück");
      $session[user][specialinc] = "";
      
}
