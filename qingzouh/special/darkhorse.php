...
case "tavern":
    checkday();
    output("`rDu stehst in der Nähe des Eingangs und beobachtest das Geschehen vor dir. Während es in den meisten Tavernen ");
    output("laut und rauh zugeht, ist diese hier erstaunlich ruhig und fast leer. In einer Ecke spielt ein alter Mann mit ");
    output("einigen Würfeln. Du bemerkst, das Abenteurer, die diesen Platz gefunden haben, Botschaften in die Tische ");
...
case "leave":
case "leaveleave":
    output("`rDu verlässt die Taverne und läufst durch das dichte Blattwerk. Der seltsame Nebel ");
...
default:
    checkday();
    output("`rEine Baumgruppe in der Nähe kommt dir bekannt vor... Du bist dir sicher, diesen Platz schon einmal gesehen zu haben.  ");
...
    output("eine Holzhütte, bei der Rauch aus dem Kamin aufsteigt. Auf einem Schild über der Tür steht: \"`7Dark Horse Taverne`r\".");
