...
        $sql = "UPDATE items SET hvalue=".$session['user']['specialmisc']['houseid']." WHERE value1=".(int)$session['user']['specialmisc']['houseid']." AND owner=".$session['user']['acctid']." AND class='Schlüssel'";
