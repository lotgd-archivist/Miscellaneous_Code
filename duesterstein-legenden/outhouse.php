...
            $session['bufflist']['segen'] = array("name"=>"`8Segen","rounds"=>8,"wearoff"=>"Der Segen der Waschraumfee wirkt nicht mehr.","defmod"=>1.1,"roundmsg"=>"`8Der Segen der Waschraumfee schützt dich.","activate"=>"offense"); 
        } 
        if ($giveagem == 1){ 
