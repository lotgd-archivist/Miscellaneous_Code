...
}else if ($session[user][gold]<= 5) {
    output("`^Zum Glück kannst du deinen kleinen Besitz schnell wieder aufsammeln.`n`n`0");
...
    $mailmessage = "`^".$session['user']['name']."`2 stürzte im Wald über einen Ast und verlor dabei sein Gold.`n`n" 
...
    $mailmessage1 = "`^".$session['user']['name']."`2 stürzte im Wald über einen Ast und verlor dabei sein Gold.`n`n" 
        ."Ein paar Goldstücke rollten dir dabei vor die Füße, die du aufgehoben und behalten hast. " 
...
    $mailmessage2 = "`^".$session['user']['name']."`2 stürzte im Wald über einen Ast und verlor dabei sein Gold.`n`n" 
        ."Ein paar Goldstücke rollten dir dabei vor die Füße, die du aufgehoben und behalten hast. " 
