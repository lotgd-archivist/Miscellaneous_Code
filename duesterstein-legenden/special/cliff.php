...
if ($HTTP_GET_VARS[op]==""){
    output("`nVor Dir erstreckt sich ein Gebiet, übersäht mit Felsen. Etwas entfernt
...
        break;
        case 4:
        output("Du findest einen einzelnd stehenden Strauch, der grosse `$ rote`0 Früchte
