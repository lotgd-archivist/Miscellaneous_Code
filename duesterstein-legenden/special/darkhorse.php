...
    addnav("Betrete die Taverne","forest.php?op=tavern");
...
    output("einigen Würfeln. Du bemerkst, daß Abenteurer, die diesen Platz gefunden haben, Botschaften in die Tische ");
    output("geritzt haben. Hinter der Theke humpelt ein alter Mann herum und poliert Gläser - ");
    output("obwohl niemand hier zu sein scheint, der sie benutzen würde.`n");
    //output("Seitlich in einer Nische siehst du einen rundlichen Kerl hinter einem knisternden Grill stehen.");
    
...
                    }
                    //added by Gargamel
                    addnav("Nochmal spielen?","forest.php?op=oldman&game=dice");
                    addnav("Andere Spiele","forest.php?op=oldman");
                    //added by Gargamel
                    addnav("Zurück zur Taverne","forest.php?op=tavern");
                }
