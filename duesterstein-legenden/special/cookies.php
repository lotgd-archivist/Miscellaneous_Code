...
if ($HTTP_GET_VARS[op]=="") 
{ 
    output("`n`6Auf der Suche nach weiteren Gegnern steigt Dir plötzlich ein süßlicher Geruch in die Nase. Irritiert biegst Du die Zweige des nächsten Buschs auseinander und hast klaren Ausblick auf eine nahezu kreisrunden Platz, der mit `7schwarz-`&weißen `6Platten ausgelegt ist, auf denen dünnes `2Gras `6wuchert. `nIn der Mitte dieses Ortes steht ein quadratischer `&weisser `6Stein, von leichtem Dunst umgeben, auf dem ein Gebäckstück in Form eines `^`bKekses`b `6liegt!`nDer verlockende Duft läßt erahnen, das er `ifrisch`i ist, was ja eigentlich gar nicht sein kann...`n"); 

    // Player is a reptile 
    if ((int)$session[user][race] == 6) 
    { 
        output("Deine Echsensinne sträuben sich vor dem Geruch menschlichen Back-Wahns doch noch kämpfst Du mit Dir."); 
        output("`n`7Wirst Du den Keks nehmen und trotz des Ekels hinunterschlingen?`n`7Oder läßt Du lieber Deine schuppigen Finger davon?"); 
...
                break; 
            case 2: 
                output("`n`^`bes ist ein Schokokeks`b!`n`6Sogleich beginnst Du seltsamerweise in `^Erinnerungen an ".($session[user][sex]?"Deinen Märchenprinzen":"Deine Märchenprinzessin")." `6 zu schwelgen. Als Du bemerkst, daß Du den Keks schon aufgegessen hast und immer noch verträumt lächelst, fühlst Du Dich viel wohler in Deiner Haut. Du kehrst gut gelaunt in den Wald zurück.`n`n"); 
...
                break; 
            case 5: 
                output("`n`^`bes ist ein Goldkeks`b!`n`6Wie schön wäre es doch wenn der Keks echtes Gold wäre! Plötzlich springt ein kleiner Kobold aus dem Gebüsch, klaut Dir den angebissenen Keks aus der Hand und rennt mit meckerndem Lachen lachend davon. Wütend willst Du dem Dieb hinterher rennen, bemerkst jedoch ein `^Säckchen voller Gold`6 vor Deinen Füßen liegen, welches der Kobold wohl verloren haben muss. Zufrieden nimmst Du das Säckchen Gold als Entschädigung an Dich und verlässt die Lichtung wieder in Richtung Wald.`n`n"); 
