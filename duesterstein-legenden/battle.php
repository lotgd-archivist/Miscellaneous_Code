...
            "name"=>"`&GOD MODE",
            "rounds"=>1,
            "wearoff"=>"Du fühlst Dich wieder tödlich.",
            "atkmod"=>25,
            "defmod"=>25,
            "invulnerable"=>1,
...
                    "effectmsg"=>"Du regenerierst um {damage} Gesundheitspunkte.",
...
                    "minioncount"=>1,
                    "effectmsg"=>"Eine gewaltige Faust aus Erde trifft {badguy} mit `^{damage}`) Punkten.",
                    "minbadguydamage"=>1,
...
                    "effectmsg"=>"Du wirst geheilt um {damage} Gesundheitspunkte.",
                    "effectnodmgmsg"=>"Du fühlst ein Prickeln, als deine Waffe versucht, deinen vollständig geheilten Körper zu heilen.",
...
                    "damageshield"=>2,
                    "effectmsg"=>"{badguy} wird von einem Blitzbogen aus deiner Haut zurückgeworfen und bekommt `^{damage}`) Schaden.",
                    "effectnodmg"=>"{badguy} ist leicht geblendet von deinen Blitzen, ansonsten aber unverletzt.",
                    "effectfailmsg"=>"{badguy} ist leicht geblendet von deinen Blitzen, ansonsten aber unverletzt.",
                    "activate"=>"offense,defense"
                );
                break;
            }
...
                    "name"=>"`\$Skelette herbeirufen",
                    "rounds"=>5,
                    "wearoff"=>"Deine Skelettdiener zerfallen zu Staub.",
...
                    "startmsg"=>"`n`\$Du holst eine winzige Puppe hervor, die aussieht wie {badguy}`n`n",
...
                    "startmsg"=>"`n`^Diu gibst {badguy} einen schlimmen Namen und bringst deinen Gegner zum Weinen.`n`n",
                    "name"=>"`^Erniedrigen",
                    "rounds"=>5,
...
                "name"=>"`&Bodyguard",
                "rounds"=>5,
                "wearoff"=>"Es scheint als sei der Leibwächter eingeschlafen.",
                "minioncount"=>1,
                "maxgoodguydamage"=> round($session['user']['level']/2,0) +1,
                "effectmsg"=>"`7{badguy}'s Leibwächter trifft Dich mit `\${damage}`7 Schaden.",
                "effectnodmgmsg"=>"`7{badguy}'s Leibwächter versucht Dich zu treffen aber `\$VERFEHLT`7!",
                "activate"=>"roundstart"
                );
        }
    }
...
            }
            if ($creaturedmg==0){
                output("`4Du versuchst `^$badguy[creaturename]`4 zu treffen, aber du `\$TRIFFST NICHT!`n");
                process_dmgshield($buffset[dmgshield], 0);
                process_lifetaps($buffset[lifetap], 0);
            }else if ($creaturedmg<0){
                output("`4Du versuchst `^$badguy[creaturename]`4 zu treffen, aber sein `\$GEGENSCHLAG`4 trifft dich mit `\$".(0-$creaturedmg)."`4 Schadenspunkten!`n");
                $badguy['diddamage']=1;
...
        output("`4Du bist zu beschäftigt damit wegzulaufen wie ein feiger Hund und kannst nicht kämpfen gegen `^$badguy[creaturename]`4.`n");
    }
...
            process_lifetaps($buffset[lifetap], 0);
        }else if ($selfdmg<0){
            output("`^$badguy[creaturename]`4 versucht dich zu treffen, aber dein `^GEGENSCHLAG`4 trifft mit `^".(0-$selfdmg)."`4 Schadenspunkten!`n");
