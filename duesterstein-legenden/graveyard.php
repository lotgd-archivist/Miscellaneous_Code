...
    \"`0Dein sterblicher Köper hat dich im Stich gelassen. Und jetzt wendest du dich an mich. Es gibt in diesem Land diejenigen, die sich meinem Griff entziehen konnten und ein Leben über das Leben hinaus besitzen. Um mir deinen Wert für mich zu beweisen 
...
        if ($session[user][thefttoday]==1) output(" Er weist dich noch darauf hin, dass er keinen Einfluss auf das Gedächtnis der Lebenden - und besonders der Händler -  hat."); 
        if ($session[user][thefttoday]==2) output("`n`n\"`7Wegen der Unehrenhaftigkeit deines Todes kann ich dir nicht erlauben, vorzeitig zu den Lebenden zurückzukehren, obwohl du mir gute Dienste geleistet hast.`)\""); 
        if ($session[user][thefttoday]<2) addnav("e?Wiedererwecken (100 Gefallen)","newday.php?resurrection=true"); 
