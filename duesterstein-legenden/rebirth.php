...
        if ($session[user][dragonkills]<4) output("einige");
        if ($session[user][dragonkills]>=4 && $session[user][dragonkills]<9) output("ein paar");
        if ($session[user][dragonkills]>=5) output("einen");
