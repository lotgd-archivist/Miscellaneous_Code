...
            <td>'.$i.'</td>
            <td>'.jslib_getmenuuserlink( $p, $p, true, '{m_prof: '.$p['profession'].'}' ).'</td><td>`7';
...
        if( $admin_mode > 0 ){
            $js_add = '
                var PROF_PRIEST_HEAD = '.PROF_PRIEST_HEAD.';
                var PROF_PRIEST         = '.PROF_PRIEST.';
                var PROF_PRIEST_NEW     = '.PROF_PRIEST_NEW.';
...
        if( $admin_mode > 0 ){
            $js_add = '
                var PROF_WITCH_HEAD = '.PROF_WITCH_HEAD.';
                var PROF_WITCH         = '.PROF_WITCH.';
                var PROF_WITCH_NEW     = '.PROF_WITCH_NEW.';
                var PROF_ADMIN_MODE     = '.$admin_mode.';
                var pmi_hohep, pmi_new, pmi_degrade;
...
            $str_out .= '<tr class="'.($i%2?'trlight':'trdark').'">
            <td>'.$i.'</td>
            <td>'.jslib_getmenuuserlink( $p, $p, true ).'</td>
...
            <th><img src="images/male.gif" alt="männlich"> Name</th>',true);
        }
        else {
...
    addnav('Zu den Göttern','gott.php');
...
        addnav("Sofortiges Fest!","tempel.php?op=wunder_ok&wunder=auferstehung");
...
        if($i['tpl_id'] == "tmplsgn" || $i['tpl_id'] == 'hxsgn')
        {
