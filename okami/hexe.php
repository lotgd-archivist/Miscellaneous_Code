...
    "`%Hiermit erhältst du die Möglichkeit, erneut eine Heldentat zu vollbringen. Doch diesmal mache es richtig!`!" Sie läßt deine Hand los und die Edelsteine sind verschwunden.`n
...
        "`%Was erwartest du jetzt von mir? Geh einfach zu deinem Liebhaber und flirte. Du brauchst dazu keinen weiteren Rat einer alten Frau.`!"`n`n');
...
    else
    {
        output('`!"`%Du hast gar keine '.$gemscost.' Edelsteine! `bRAUS HIER!`b`!" Mit diesen Worten trifft dich ein magischer Schlag mit voller Wucht und wirft dich aus der Hütte.
...
        if ( $count )
        {
            output('`!Die Hexe sucht aus einem Regal voller Puppen eine heraus, die wie dein Opfer aussieht. Sie stutzt kurz, dann dreht sie sich zu dir um: "`%Jaja, es ist alles in Ordnung. Dein Opfer leidet bereits unter '.$row['tpl_name'].'`%. Behalte dein Geld. Einen schönen Tag noch. Und jetzt ... lass mich alleine.`!"');
        }
...
        Wenn du mir`^  '.$wkcost.' `%von deinem Gold gibst, lasse ich dich von meinem Aufputschpunsch kosten und du könntest noch ein paar Monster mehr erschlagen. ');
...
            output('Oder du gibst mir `^ '.$spcost.' `% Gold und ich verspreche dir ein besonderes Ereignis im Wald, sobald du meine Hütte verlässt.');
        }
        addnav('Zurück in den Wald', 'forest.php');
