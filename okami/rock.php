...
    Du willst gerade '.($session['user']['sex']?'einen jungen Mann':'eine junge Dame').' ansprechen, als dich eine nervös wirkende Echse zur Seite zieht:
...
    Ich habe Sssschulden in Höhe von `^'.$preis.'`# Gold.
...
        `n`nDu stellst fest, dass sich die Rechnung des guten Zwerges auf mitlerweile `^'.$price.'`3 Goldmünzen beläuft, und weniger wird es sicher nicht je länger du wartest.
