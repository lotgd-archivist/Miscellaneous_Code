...
* Autor: Fossla (fossla [-[at]-] atrahor.de || ICQ: 270-812-802)
*/
...
                ... Nachdem du dich ein wenig mit dem Mädchen unterhalten hast und nun weißt, dass sie sich verlaufen hat, lässt sie sich von dir den Weg zurück ins Dorf schildern und läuft fröhlich und dankbar von dannen.`n
...
            $session['user']['specialinc'] = '';
            addnav('Flucht ins Dorf!','village.php');
        }
        else {
