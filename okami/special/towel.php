...
* Hitchikers Guide to Atrahor: Wenn du in diesem Dorf überleben willst, musst du immer wissen wo dein Handtuch ist.
...
                    $item['tpl_name']='`&Weisse Maus`0';
                    $item['tpl_description']='Mit weissen Mäusen kann man Experimente machen. Doch Vorsicht: Die Sache könnte seltsame Folgen haben!';
                    $item['tpl_special_info']='Männchen';
                    item_add($session['user']['acctid'],'squirra',$item);
...
        {
            output('`7Du erklärst dem Gnom dass du kein Handtuch besitzt. Dieser zeigt sich betroffen und schenkt dir eins mit den Worten: "`2Wenn du in diesem Dorf überleben willst, musst du immer wissen wo dein Handtuch ist.`7"`n`n');
