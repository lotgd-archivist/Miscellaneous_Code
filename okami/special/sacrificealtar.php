...
                `n`nDu nimmst deine Sachen wieder auf und machst du bereit weiterzugehen. 
                Als du an einer Wasserpfütze vorbei gehst, siehst du zufällig in sie und siehst dein Spiegelbild.
...
        output('`2Du entscheidest dich, einen armen Dorfbewohner an die Götter zu opfern. 
        Darum gehst du ins Dorf und suchst jemanden, den du zu einer Opferzeremonie "überreden" kannst.`n');
        $session['user']['turns']--;
...
            output('`$Du gehst in ein Gebiet des Dorfes, von dem du weißt, dass sich dort eher hilflose Einwohner aufhalten.`0`n');
        }
...
            output('`$Du gehst in ein Gebiet des Dorfes, in dem die fiesesten Schläger zu hause sind, in der Hoffnung, dort einen Verletzten zu finden.`0`n');
        }
        else
        {
...
            $badguy['creatureexp']=($badguy['creatureexp']+1)*10+$epflux;
