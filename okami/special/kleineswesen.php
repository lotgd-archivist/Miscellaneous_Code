...
            `n`n`@Als du die verlorengeglaubte Seele bis zum Dorfrand geleitet hast, bekommst du für deine ehrvolle Tat eine Belohnung in Höhe von `^'.$gems.'`@ Edelsteinen!
...
            }
            $arr_npc=array('Violet','Seth','Dag Durnick','Cedrik','Aeki','Pegasus','Thorim','Merik','Vessa','Petersen');
