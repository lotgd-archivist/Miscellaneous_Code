...
UPDATE by Piercy
// 12-08-2005
// E-Mail: piercy [-[at]-] lotgd-world.de
// Many fixed and something added

10.5.07: Komplettüberarbeitung und Anpassung für Atrahor by Salator (salator [-[at]-] gmx.de)
...
        }
        //story
        output('`)`c`bDer Pranger`b`c
        `)Auf dem matschigen Richtplatz steht ein massiver Eichenstamm von etwa zwei Meter neunzig Größe. Aus seinem Holz ragen schwere Eisenketten, an deren Enden dicke Ringe befestigt sind.`n
...
        Du siehst, dass '.$jailedplayers.' Halunken an dem Pranger angekettet sind.`n`n');
...
                    'pqtemp'=>addslashes($_POST['pranger_reason']),
                ),
                $row['acctid']
            );
        }
