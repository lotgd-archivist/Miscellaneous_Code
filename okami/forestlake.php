...
    if (!strpos($session['user']['specialmisc'],'_swim'))
    {
        addnav('Im See schwimmen','forestlake.php?op=swim');
    }
    if (!strpos($session['user']['specialmisc'],'_music'))
    {
        addnav('Musizieren','forestlake.php?op=music');
    }
    if (!strpos($session['user']['specialmisc'],'_picknick'))
    {
...
    }
    if ($loverHorseID+$lovedHorseID>0 && !strpos($session['user']['specialmisc'],'_ride') )
    {
...
        if (!strpos($session['user']['specialmisc'],'done:'))
        {
