...
            <input name='hidden_pw' value=\"$str_password\" type='hidden'>
...
    `n');
    addnav('`yCharakter erstellen`0','create_rules.php?r='.$demoacctid,false,false,false,false);
}
...
                            emailaddress='user [-[at]-] domain.invalid',
                            emailvalidation='',
...
            $arr_data = array('sex'=>0,'pass1'=>'demo','pass2'=>'demo','email'=>'user [-[at]-] domain.de','name'=>$name);
