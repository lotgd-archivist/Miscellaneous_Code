...
        und rauchenden Schornsteine deines Heimatdorfes '.getsetting('townname','Atrahor').' erkennen.`n
...
        Du gehst schnellen Schrittes weiter durch den dir heimatlich bekannt vorkommenden Wald und kannst schon bald das Dorftor von '.getsetting('townname','Atrahor').' erblicken.
...
        `n`n<li> Du giltst nicht als Verschollen und dir wird kein Grabstein gesetzt, sofern du `$innerhalb von '.$vacation.' Tagen`0 (bis '.date('d. m. Y',time()+($vacation*86400)).') ins Dorf `$zurückkehrst`0.
