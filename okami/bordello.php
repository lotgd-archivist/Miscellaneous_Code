...
/* The House of Sin
** By Phudgee - phudgee [-[at]-] oldschoolpunk.com
...
** angepasst für www.silienta-logd.de und bugfixe durch Rikkarda [-[at]-] silienta-logd.de
** & Gargamel [-[at]-] silienta-logd.de
...
$session[user][standort]="Haus der Sinne";
...
            {
                output('`n`4Du bist die Witzfigur des Tages im Dorf! Du verlierst 2 Charmepunkte.`n');
                $session['user']['charm']-=2;
            }
            else
            {
                output('`n`4Du bist die Witzfigur des Tages im Dorf! Du verlierst deine letzten Charmepunkte.`n');
...
        `4Es ist dir peinlich, ins Dorf zu gehen. Erst in der Abenddämmerung traust du dich. Du verlierst Waldkämpfe.`n');
...
        Er erzählt im ganzen Dorf wie gut du im Bett bist!!!`n
        Du verlässt das Bordell erhobenen Hauptes!!!`n`n
        `RDu bist die meistverehrte Person im Dorf! Du erhältst ein paar Waldkämpfe.`n');
...
        `n`n`4Es ist dir peinlich ins Dorf zu gehen. Erst in der Abenddämmerung traust du dich. Du verlierst Waldkämpfe.`n');
        $buff = array("name"=>"`4Peinlichkeit`0","rounds"=>60,"wearoff"=>"`5`bDu hast deine Peinlichkeit überwunden!`b`0","defmod"=>.65,"atkmod"=>.65,"roundmsg"=>"Du bist zu verlegen um voll zu kämpfen!","activate"=>"offense");
        $session['bufflist']['bordello']=$buff;
        $session['user']['turns'] -= round($session['user']['turns']*0.5);
        
...
        Sie erzählt im ganzen Dorf, wie gut du im Bett bist!!!`n
        Du verlässt das Bordell erhobenen Hauptes!!!`n
        `n`RDu bist die meistverehrte Person im Dorf! Du erhältst ein paar Waldkämpfe!`n');
        $buff = array("name"=>"`4Großer Liebhaber`0","rounds"=>60,"wearoff"=>"`5`bDu fühlst dich nicht mehr länger hochmütig!`b`0","defmod"=>1.35,"atkmod"=>1.35,"roundmsg"=>"Der Stolz fließt durch deine Adern!","activate"=>"offense");
        $session['bufflist']['bordello']=$buff;
        $session['user']['turns'] += 5;
    }
