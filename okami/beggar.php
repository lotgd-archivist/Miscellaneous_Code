...
{
    addcommentary();
    output('`)Hier lungern verarmte Helden aller Ränge herum, die offenbar nicht wissen, dass man im Wald selber Gold verdienen kann, um sich der niveaulosesten aller Sachen herzugeben - betteln.
...
        output('`n`n`0Es liegen noch `^'.$goldsumme.' Goldstücke`0 auf dem Spenden-Stein bereit.');
    }
