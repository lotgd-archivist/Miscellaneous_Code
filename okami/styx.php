...
        {
            $output .= ' <embed src="media/lachen.wav" width="10" height="10" autostart="true" loop="false" hidden="true" volume="100"> ';
        }
...
        output('
            `4Hatetepe`9 verspricht dir, '.($gems>1?$gems.' Edelsteine':'einen Edelstein').' für dich im Dorf bereit zu legen. 
