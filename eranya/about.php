...
page_header('Über Legend of the Green Dragon (Eranya Edition)');
...
        //addnav('Impressum Atrahor','about.php?op=impressum_atrahor');
        addnav('Datenschutzerklärung','about.php?op=datenschutzerklaerung');
...
        'expirevacationacct'=>'Accounts im Urlaubsmodus werden nach x Tagen gelöscht. x =,viewonly',
...
elseif($_GET['op']=='impressum_atrahor')
{
        output(get_extended_text('impressum_atrahor'),true);
        addnav('Über LoGD','about.php');
}
...
elseif($_GET['op']=='datenschutzerklaerung')
{
        output(get_extended_text('datenschutzerklaerung'),true);
        addnav('Über LoGD','about.php');
}
