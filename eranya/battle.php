...
                        }
                        if (isset($buff['liferaise']))
                        {
                                $hpgain = ($session['user']['maxhitpoints']*$buff['liferaise']) - $session['user']['maxhitpoints'];
                                $result['liferaise'] *= $hpgain;
                        }
...
                                                $out .= '`)'.$msg.'`n';
                                        }
                                        if(isset($buff['liferaise']) && $buff['liferaise'] != 1)
                                        {
                                                $session['user']['hitpoints'] = round($session['user']['hitpoints']/$buff['liferaise']);
                                                $session['user']['maxhitpoints'] = round($session['user']['maxhitpoints']/$buff['liferaise']);
                                        }
...
{
        $badguy['creaturesex'] = (isset($badguy['creaturesex']) ? (bool)$badguy['creaturesex'] : false);

        $out .= '`$`c`b~ ~ ~ Kampf ~ ~ ~`b`c`0`n
                 `FDu hast `I'.$badguy['creaturename'].'`F entdeckt, '.($badguy['creaturesex'] ? 'die' : 'der').' sich mit '.($badguy['creaturesex'] ? 'ihrer' : 'seiner').' Waffe `I'.$badguy['creatureweapon'].'`F auf dich stürzt!`0`n`n';

        if ($session['user']['alive'])
        {
                $out .= '`2Level: `^'.$badguy['creaturelevel'].'`0`n`n';
        }
        else
        {
                $out .= '`2Level: `ôUntoter`0`n`n';
        }


        $out .= '`@`b~ Beginn der Runde:`b`n
                 `2'.$badguy['creaturename'].'`2'.(substr(strip_appoencode($badguy['creaturename'],3),-1) == 's' ? '\'' : 's').' '.$hp_name.': `6'.round($badguy['creaturehealth']).' `0`n
...
{
        $out .= '`n`@`b~ Ende der Runde:`b`n
`2'.$badguy['creaturename'].'`2'.(substr(strip_appoencode($badguy['creaturename'],3),-1) == 's' ? '\'' : 's').' '.$hp_name.': `6'.$badguy['creaturehealth'].'`0`n
