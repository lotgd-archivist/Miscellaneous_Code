...
su_check(SU_RIGHT_EDITOREQUIPMENT,true);
...
addnav("Rüstungseditor Home","su_armoreditor.php?level=$armorlevel");

addnav("Rüstung hinzufügen","su_armoreditor.php?op=add&level=$armorlevel");
...
        }
        output("<tr>",true);
        output("<td>[<a href='su_armoreditor.php?op=edit&id=$row[armorid]&level=$armorlevel'>Edit</a>|<a href='su_armoreditor.php?op=del&id=$row[armorid]&level=$armorlevel' onClick='return confirm(\"Diese Rüstung wirklich löschen?\");'>Löschen</a>]</td>",true);
