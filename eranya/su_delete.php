...
                    send_email($a['emailaddress'], getsetting('townname','Atrahor').' - Account gelöscht',
...
                    db_query($sql);
                
                    $sql = 'INSERT INTO blacklist SET value="'.$str_login.'",type='.BLACKLIST_LOGIN.',remarks="Anlässl. Löschung des Spielers '.addslashes($a['login']).'"';
                    db_query($sql);
                }
