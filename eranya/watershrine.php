...
{
output ("`&Mit stark pochendem Herzen trittst du an den Schrein und drückt deinen Arm gegen die Glyphe. Ein grauenvoller Schmerz durchzuckt deinen ganzen Körper, als sich die Glyphe in dein Fleisch brennt. Das wird hässliche Narben geben! Du verlierst 5 Charmepunkte.");
$session['user']['charm']-=5;
debuglog("Gab 5 Charme am Wasserschrein.");
   switch(e_rand(1,3)){
      case 1 :
      case 2 :
