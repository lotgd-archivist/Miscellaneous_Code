...
        case 2352:
            if($session['user']['turns'] > 0){
                redirect("mazemonster.php?op=fight&fiend=gardner");
            }
        break;
        case 2353:
        case 2354:
...
                $out .= "`^Du erhältst einen Charmpunkt!";
                $session['user']['charm']++;
            }
        break;
        case 2380:
...
        case 2393:
            if($session['user']['turns'] > 0){
                redirect("mazemonster.php?op=fight&fiend=bigspider");
            }
        break;
        case 2394:
        case 2395:
...
        case 2429:
            if($session['user']['turns'] > 0){
                redirect("mazemonster.php?op=fight&fiend=zyklop");
            }
        break;
        case 2430:
        case 2431:
...
        case 2457:
        case 2458:
        //if($session['user']['turns'] > 0) redirect("mazemonster.php?op=fight&fiend=ghost1");
        break;
        case 2459:
        case 2460:
        case 2461:
        //if($session['user']['turns'] > 0) redirect("mazemonster.php?op=fight&fiend=bat");
        break;
        case 2462:
        case 2463:
        case 2464:
