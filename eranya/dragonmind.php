...
$int_max_win = (50 * $session['user']['level']);
...
    {
        output("Der Barkeeper raunzt dich an:`7\"`9Hier kannst du um ein paar Goldstücke spielen. Du bist aber schon viel zu erschöpft, das sehe ich mit dem Auge des Kenners auf den ersten Blick! *HARHAR*`7\".");
    }
    else
    {
...
        
        if($bool_no_gold) {
                output('`n`7"`9Nur hast du heute schon genug gewonnen.. Dieses Mal darfst du dich ganz ohne finanzielle Beteiligung am Spiel versuchen.`7"');                        
        }
        
...
    for ($i=0; $i<$rs; $i++)
    {
        $bilder_aktuell.='<img src="./images/dm_green.gif" alt="Richtige Farbe an richtiger Stelle">';
    }
    for ($i=0; $i<$rf; $i++)
    {
        $bilder_aktuell.='<img src="./images/
dm_red.gif" alt="Richtige Farbe an falscher Stelle">';
    }
    
    if ($rs==4)
    {
...
        {
            $bilder.='<img src="./images/dm_green.gif" alt="Richtige Farbe an richtiger Stelle">';
        }
        for ($k=0; $k<$auswertung[1]; $k++)
        {
            $bilder.='<img src="./images/dm_red.gif" alt="Richtige Farbe an falscher Stelle">';
        }
        output("<tr>
...
Dir wird mitgeteilt ob du richtige Farben gewählt bzw diese auch an der richtigen Stelle plaziert hast.`n
Ist eine der Farben richtig gewählt und steht zudem an der richtigen Stelle, erscheint ein `@grüner Punkt <img src=\"./images/dm_green_small.gif\" alt=\"Richtige Farbe an richtiger Stelle\">`7.
Befindet sich die richtige Farbe dagegen an der falschen Stelle, erscheint ein `\$roter Punkt <img src=\"./images/dm_red_small.gif\" alt=\"Richtige Farbe an falscher Stelle\">`7.
Um welche Farbe es sich allerdings genau handelt, wird nicht verraten!`n`n
