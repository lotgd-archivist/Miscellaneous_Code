...
    case 'raze':
//oh oh
//Kurze Verlegenheitslösung:
    if ($session['user']['sex'])
    {
    output("`&Du streichst durch dein Gesicht, in stiller Hoffnung keinen Damenbart zu entdecken.`n
    Und siehe da: Glatt wie ein Babypopo!");
    }
    else
    {
    output("`&Nach einem Blick auf das rostige Metzgerwerkzeug des Barbiers entschliesst du dich ihn doch nicht an deine zarte Gesichtshaut zu lassen.");
    }
        break;
    case 'donate':
