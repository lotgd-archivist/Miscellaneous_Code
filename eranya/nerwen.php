...
                db_query($sql);
                                
                insertcommentary(1,'/x Eine Elster landet am offenen Fenster, fliegt zur Schatztruhe und schnappt sich einen Edelstein.','house-'.$row['houseid']);
                
...
                db_query($sql);
                
                insertcommentary(1,'/x Ein Edelstein fällt vom Himmel und kullert direkt vor die Schatztruhe.','house-'.$row['houseid']);
                
