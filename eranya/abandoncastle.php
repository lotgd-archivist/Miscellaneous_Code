...
    /*if (($opentime<3 || $opentime>23) && !su_check(SU_RIGHT_CASTLECHOOSE))
    {
...
        output("`@Das verlassene Schloss. Öffnungszeiten von 02:00 - 23:00.`n");
...
    }
    else if($session['user']['castleturns'] <= 0)
    {
        output("`2 Als du auf das verlassene Schloss zureitest bist Du frohen Mutes Dich endlich einmal mehr beweisen zu können und diesem dunklen Gemäuer ein paar mehr Geheimnisse oder sogar Gold entreissen zu können.");
...
        output("`2`nDu kehrst dem Schloss dem Nacken und entfernst Dich langsam. Mit jedem Schritt lässt das Prickeln auf Deinem Nacken ein wenig mehr nach, bis Du schließlich wieder in Eranya ankommst.");
...
                }
                elseif( $_GET['choose']==1 || (!su_check(SU_RIGHT_CASTLECHOOSE) && e_rand(1,24)%2)){
...
                        addnav('Zurück');
                        addnav("Zurück zur Stadt","abandoncastle.php?out=leave");
                }
                else{
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=bigbat");
                }
                break;
            case 2353:
            case 2354:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=lost_soul");
                }
                break;
            case 2384:
            case 2385:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=devoured_soul");
                }
                break;
            case 2394:
            case 2395:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=ghost3");
                }
                break;
            case 2430:
            case 2431:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=ghost2");
                }
                break;
            case 2446:
            case 2447:
...
                {
                    redirect("mazemonster.php?op=fight&fiend=rat");
                }
                break;
            case 2452:
            case 2453:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=ghost1");
                }
                break;
            case 2459:
            case 2460:
...
                if ($session['user']['turns'] > 0)
                {
                    redirect("mazemonster.php?op=fight&fiend=bat");
                }
                break;
            case 2462:
            case 2463:
...
                                if ($session['user']['turns'] > 0)
                {
                                        redirect("mazemonster.php?op=fight&fiend=minotaur");
                                }
                break;
            case 2467:
            case 2468:
...
                                addnav('Minotaurus',"mazemonster.php?op=fight&fiend=minotaur");
