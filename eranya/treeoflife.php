...
            $session['bufflist']['865'] = array("name"=>"`2Der Segen des `@Baumes",
            "rounds"=>10,
...
            break;
        case 14:
            output("`^Einige Früchte fallen zu Boden.  \"Die Früchte sehen etwas seltsam aus\", denkst Du dir. Du denkst an deinen Hunger und beschließt, dass sie die Konsequenzen wert sind!!!");
...
            $session['bufflist']['999'] = array("name"=>"`4Fluch `7des `@Baumes",
            "rounds"=>10,
