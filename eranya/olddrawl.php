...
* 
* Rimgar ist geschaffen worden, um den Spielern in der Kneipe Specials zu ermöglichen, die Ihnen das
* Spiel ein wenig erleichtern. Allerdings soll das Ansprechen von Rimgar sowei das Benutzen seiner
...
* Version:    1.3 Rimgar das Erschlagen des Fragenden auf Zufallsbasis wegen Balancing eingebaut
...
    $zufall = e_rand(1,8); 
        output("`@`b`cRimgars Stammtisch`c`b`0`n`n");
        output("`@Du hast es gewagt und Rimgar angesprochen. Langsam dreht der alte Mann seinen Kopf zu Dir herum
...
                output("`n`nRimgar macht eine Faust, holt aus und ");
                switch(e_rand(1,5)){ 
                        case 1: 
...
                        //debuglog("`^Rimgar `@haut 3 Charmpunkte weg");
...
                        //debuglog("`^Rimgar `@haut 2 Lebenspunkte weg");
            */
...
                        $session['user']['gold']=0; 
                        //debuglog("`^Rimgar `@raubt {$session['user']['gold']} Gold.");
                        break;     
                        case 4: 
...
                        killplayer(100,8,0,'');
                                                
                           debuglog("Hat {$session['user']['gold']} Gold und 2 Edelsteine bei Rimgar verloren");
                                                   
                        $session['user']['gems']-=2; 
                        
...
                        addnews("`0".$session['user']['name']." `0wurde von Rimgar erschlagen, als ".($session['user']['sex']?"sie":"er")." ihn angesprochen hat.");
                        break; 
                        case 5: 
...
                output("`@`b`cRimgars Stammtisch`c`b`0`n`n");
                output("`@Für die Aktion `^3 mal Goldmine im Wald `@verlangt Rimgar `42 `@Edelsteine.
...
                //debuglog("`^Rimgar `@wegen Goldmine angesprochen");
...
                            $session['user']['gems'] -= 2;
                            output("`n`n`@Rimgar gibt dir eine halb zerfallene Karte zur Goldmine. Du wirst sie wohl tatsächlich nur 3 mal verwenden können.");
                            //debuglog("`^Rimgar `@macht Zugang zur Goldmine auf");
                        }elseif ($config['goldmineday']==1){ 
                            output("`n`n`@Rimgar ist heute zu müde um Dir helfen zu können - komm morgen wieder!");
                        }else{ 
...
        output("`@Die Neugier siegt in Dir und Du trittst vorsichtig an den Tisch, wo immer der alte Kauz, den alle Rimgar nennen,
