...
    }else{
        output("`9 Die vielen Hände, die aus dem Fluss nach dir greifen, lassen dich nur langsam vorankommen. Schließlich zerren sie dich ganz in den Fluss. Du wirst zurück ins Totenreich geschwemmt - direkt vor `\$Jarcaths`9 Füsse.");
...
    page_header("Der Seelenfluss");
    if ($_GET['subop']=="favor"){
        output("`9Für ein paar mehr Gefallen bei `\$Jarcath`9 würdest du sogar deine Seele verkaufen. Ups! Lieber doch nicht. So versprichst du dieser trotteligen Seele");
...
        output("`4Hatetepe`9 verspricht, ein gutes Wort für dich bei `\$Jarcath`9 einzulegen. Gerade als du ihn fragen willst, was er hier unten überhaupt mit Edelsteinen anfangen will, ");
