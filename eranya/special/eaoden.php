...
output('`2"`9Ahh, du musst `@'.$session['user']['name'].' `9sein!? Ich habe von dir gehört... aber ich vermute, dass dich dein/deine '.$session['user']['armor'].' nicht genügend schützt, nicht wahr!?`2"`n`n');
