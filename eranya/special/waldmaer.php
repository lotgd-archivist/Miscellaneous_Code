...
    case 'run':    // Fliehen
        if(e_rand(1,5) == 1) {
            output('`@Endlich schaffst du es, dich in die Büsche zu schlagen! Während du um dein Leben rennst, hörst du noch lange
            ein zum Glück immer leiser werdendes Rascheln hinter dir...`0');
            $session['user']['specialinc'] = '';
            addnav('Flucht ins Dorf!','village.php');
        }
        else {
            output('Deine Fluchtversuche bleiben ohne Erfolg. Das Monster schneidet dir regelmäßig den Weg ab!`n`n');    
            $battle=true;
        }                
        break;
    default:
