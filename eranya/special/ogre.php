...
{
output("`tLeider war {$choice} für die Bestie nur etwas für den hohlen Zahn und bevor du dich versiehst hat dir das Monstrum schon den Arm ausgerissen und kaut genüsslich darauf herum. Doch du bekommst von all dem nicht mehr viel mit, da sich vor deinem geistigen Auge schon die Pforten zu Jarcaths Reich auftun.`n`4DU BIST TOT!`nDu kannst morgen wieder spielen.`&`n");
$session['user']['specialinc']="";
$session['user']['hitpoints']=0;
addnews("`#".$session['user']['name']." `t wurde heute zu einem Snack für ein Ungetüm.");
addnav("Weiter","shades.php");
