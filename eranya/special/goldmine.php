...
                            if ($horsecanenter)
                            {
                                output('Dein '.$playermount['mountname'].' hat es geschafft zu entkommen. Du weisst, dass das Tier darauf trainiert ist, zur Stadt zurückzukehren.`n');
                            }
                            else
                            {
                                output('Zum Glück hast du dein(e/n) '.$playermount['mountname'].' draussen angebunden. Du weisst, dass das Tier darauf trainiert ist, zur Stadt zurückzukehren.`n');
                            }
                        }
                    }
                    $exp=round($session['user']['experience']*0.1);    // Originalwert 0.6
...
                    $session['user']['gems']*=.5;
                    debuglog('verlor '.$session['user']['gold'].' Gold und  '.$session['user']['gems'].' Gems in der Goldmine (erhält  3 donation points)');
