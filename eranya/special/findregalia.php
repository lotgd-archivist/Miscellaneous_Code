...
                        Erst nach mehreren Stunden wachst du wieder auf und fühlst dich frisch und erholt!`0');
                
                $session['user']['restorepage'] = 'forest.php';
                
                addnav('Neuer Tagesabschnitt!','newday.php');
                
                debuglog('erhielt durch Petunie im Wald neuen Spieltag');
                
...
                    addnav('p?In Topf pflanzen',$str_lnk.'plant');
                    addnav('w?Beides wegwerfen',$str_lnk.'drop');
                }
                else {
                    $session['message'] = '`8Du stolperst über einen moosbewachsenen Stein. Als du deinen Blick fluchend in Richtung deines
                        schmerzenden Fußes wendest, erblickst du unter dem Laub ein mattes Schimmern.. das sich bei näherer
