...
mit deinem ".$session['user']['weapon']."`t. Als du dich nach dem Orc umschaust ist er plötzlich weg. Aber die Hauptsache ist, dass die 
...
mit deinem ".$session['user']['weapon']."`t. Als du dich nach der Elfe umschaust ist sie plötzlich weg. Aber die Hauptsache ist, dass die 
goldene Truhe noch da ist.`n`n`#Dies hat dich 1 Waldkampf gekostet.");
                
                $session['user']['turns']--;
                $session['user']['reputation']+=3;
...
hast du auch schon die Möglichkeit, `²J`ça`Âr`Îc`Âa`çt`²h`t persönlich auf die Nerven zu gehen. Dein guter Wille sollte aber nicht umsonst sein. Daher erhälst du 25 Gefallen bei `²J`ça`Âr`Îc`Âa`çt`²h`t.");
                
