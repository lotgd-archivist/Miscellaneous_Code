...
    else
    {
        output("`3Die junge Frau schaut dich eine Weile lang durchdringend an, dann sagt sie mit leiser Stimme:`n\"`8Du hast nicht, was ich dafür brauche...`3\"`n`nDu beschließt zu gehen, da dir das Ganze nun doch sehr suspekt vorkommt.`n");
        $session['user']['specialinc']="";
    }
}
...
    else
    {
        $newdesc=$doll['description']."`&; ".$name;
    }
    
    if ($lastindex==14)
    {
        $newdesc=$newdesc."`n`IWert: ".$newvalue." Drachenkills`0";
    }
    
