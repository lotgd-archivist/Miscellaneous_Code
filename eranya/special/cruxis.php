...
{
    $_SESSION['engel']=0;
    output("Es gibt Gerüchte. Gerüchte von Kreaturen - gefallenen Engeln, wie sie genannt werden, bösartige Geschöpfe, die sich vom Licht abwandten, um sich die Welten untertan zu machen. Ein wenig abseits der Stadt sollen sie vereinzelt gesichtet worden sein und ihre Opfer so gräßlich zugerichtet haben, dass sich selbst Jarcath ekelte. \"`%Alles Quatsch`0\", wenn man dich fragen würde, Schauermärchen, die am Lagerfeuer erzählt werden - und das wirst du beweisen!`n`n Als du durch den Wald streifst, bemerkst du einen unirdischen Lichtschimmer!");
...
    elseif($defeat)
    {
        output("Du wurdest durch die Hand eines gefallenen Engels getötet, niemand anderes war Zeuge dieses ungleichen Kampfes außer Jarcath, dessen Fratze Dein Bewusstsein zu füllen scheint");
...
    {
        case 1:
        output("Du entscheidest dich für die mittlere Schatulle und öffnest sie. Im Innern ist ein Fläschchen, das du öffnest und trinkst.`n");
        output("\"Hahahaha,\", lacht der Mann und schlägt dich nieder, \"Du bist mir auf den Leim gegangen.\"`n`n");
        output("Du merkst, dass du plötzlich merklich schwächer bist, und brichst dann bewusstlos zusammen.");
        addnav("Du kommst wieder zu dir","houses.php");
...
    {
        case 1:
        output("Du entscheidest dich für die große Schatulle und öffnest sie. Im Innern ist ein Fläschchen, das du öffnest und trinkst.`n");
        output("\"Hahahaha,\", lacht der Mann und schlägt dich nieder, \"Du bist mir auf den Leim gegangen.\"`n`n");
        addnav("Du kommst wieder zu dir","houses.php");
