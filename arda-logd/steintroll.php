    ...
    case "tausch":
        ...
        if($steintroll){
            $tausch = array(
                ...
                3=>array("Herzkissen","Geschenk","500","0","Ein Kissen in Herzform.",0,0,"100",0,0,3,0,0),
            ...
            $tausch = array(
                1=>array("Phoenixleder","Schmuck","500","0","Gut für schützende Kleidung geeignet.",1,4,"100",0,0,0,0,1),
                ...
                4=>array("Phoenixzahn","Schmuck","500","0","Ein echter Zahn eines Phoenix, es heißt man hätte durch ihn magische Fähigkeiten.",1,3,"100",0,0,0,0,1),

                5=>array("Sternschnuppe","Geschenk","1000","0","Wünsch Dir was und es wird erfüllt werden.",0,0,"200",0,0,5,0,0),
                6=>array("Phoenixanhänger","Schmuck","1000","0","Ein Anhänger der es in sich hat, doch was, ist seine eigene Magie?",0,0,"200",0,0,0,0,0),
                ...
                9=>array("Phoenixstein","Möbel","1000","0","Ein Stein der Freude bringt...er wechselt regelmäßig seine Farbe.",0,0,"200",0,0,0,0,0),
                10=>array("Phoenixamulett","Schmuck","1000","0","Ein Schutzamulett, welches fast unzerstörbar ist.",5,1,"200",0,0,0,0,1),
                ...
                13=>array("Goldene Phoenixstatue","Möbel","2500","1","Eine prachtvolle Statue.",0,0,"500",0,0,0,0,0),
                14=>array("Vergoldete Phoenixschuppe","Möbel","2500","1","Ein seltener Fund, der dem Besitzer Glück bringen soll.",0,0,"500",0,0,0,0,0),
                15=>array("Ardakristall","Möbel","2500","1","Ein glasklarer Kristall, der laut einer Legende Arda in seinem Inneren abbildet.",0,0,"500",0,0,0,0,0)
            );
        }
        $buffs = array(
            1=>array("name" => "Phoenixkraft", "roundmsg" => "Die Kraft des Phoenix schützt dich.",
            ...
            3=>array("name" => "Urkraft des Phoenix", "roundmsg" => "Die Kraft des Phoenix stärkt dich.",
                    "wearoff" => "Der Drache legt sich schlafen.", "effectmsg" => "Die Urkraft verstärkt deine Schläge.",
                    "rounds" => 20, "atkmod" => "1.5", "activate" => "offense"),
            4=>array("name" => "Schutz des Phoenix", "roundmsg" => "Der Drache schützt dich.",
                    "wearoff" => "Der Drache legt sich schlafen.",
        ...
        switch($_GET['act']){
            case "":
                $out="`nDu holst deinen, mit Kristallen prall gefüllten, Beutel heraus und zeigst ihm dem ".($steintroll?"Steintroll":"GrasPhoenix").". Interessiert betrachtest du die Dinge, welche er gegen deine Kristalle eintauschen möchte.`n`n";
                $i=1;
            ...
            case "kauf":
                ...
                switch($tausch[$id][1]){
                    case "Möbel":
                        $out="`nDu gibst dem ".($steintroll?"Steintroll":"GrasPhoenix")." {$tausch[$id][7]} Kristalle und bekommst dafür {$tausch[$id][0]}.`n";
...
addnav("Zum Obstgarten","gardens.php");
