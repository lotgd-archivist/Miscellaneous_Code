...
$sql = "SELECT mountname,mountid,mountcategory FROM mounts WHERE mountactive=1 AND mountdk <= $userdk AND mountdp <= $userdp  ORDER BY mountcategory,mountcostgems,mountcostgold";
$result = db_query($sql);
$category="";
