...
if ($session[user][superuser] >= 2){
    ...
    if ($HTTP_POST_VARS[save]<>""){
        ...
        if ($HTTP_POST_VARS[id]!=""){
            ...
            //bugfix by adminator start 
            $sql.= " creaturelevel=\"".$_POST['creaturelevel']."\", "; 
            $sql.= " creaturename=\"".$_POST['creaturename']."\", "; 
            $sql.= " creatureweapon=\"".$_POST['creatureweapon']."\", "; 
            $sql.= " creaturelose=\"".$_POST['creaturelose']."\", ";//bugfix end Ellalith
            ...
            //Bugfix by adminator Ellalith
$sql="INSERT INTO creatures (creaturelevel,creaturename,creatureweapon,creaturelose,createdby) VALUES (\"".$_POST['creaturelevel']."\",\"".$_POST['creaturename']."\",\"".$_POST['creatureweapon']."\",\"".$_POST['creaturelose']."\",\"".addslashes($session['user']['login'])."\")"; //Ende 
            //echo $sql;
            db_query($sql);
        }
    }
