...
if ($session['user']['loggedin']){
  ...
  output("`n`nAccounts, die du geworben hast:`n<table border='0' cellpadding='3' cellspacing='0'><tr><td>Name</td><td>Level</td><td>Ausgezahlt?</td></tr>",true);
    ...
    Hier schlüpfst du in die Rolle eines Kriegers in einer Fantasy-Welt, in der eine Legende von einem riesigen grünen Phoenix die 
    ...
    output("<li>Finde und vernichte den dunklen Phoenix, um im Ansehen zu steigen",true);
