...
if ($HTTP_GET_VARS['count']==3) {
        output("`tDer `@kunterbunte Drachen`t hat genug von deinem Geschwafel. Er bläst dich mit einem Feuerstoß weg!`n`n");
        ...
        output("Das Reich der Schatten empfängt dich.`n`n`4Du wurdest vom `@kunterbunte Drachen`4 gegrillt!`n");
        output("Du verlierst 5% deiner Erfahrung und alles Gold.");
        addnews("`%".$session[user][name]."`t wurde bei einer zufälligen Begegnung im Wald vom `@kunterbunte Drachen`t getötet!");
        $session['user']['gold']=0;
        ...
        switch($HTTP_GET_VARS[op]){
                case "":
                        ...
                        output("Langsam drehst du dich um - und siehst einen riesigen `@kunterbunte Drachen`t vor dir stehen. ");
                ...
                case "slay":
                        ...
                        if ($session['user']['level'] < 15) {
                                ...
                                output("`nGeschwächst schaust du zum `@kunterbunte Drachen`t auf, der auf dich zu stolziert. ");
                                if (rand(1,4)==1) {
                                        ...
                                        addnews("`%".$session[user][name]."`t hat irgendwie eine zufällige Begegnung mit dem `@kunterbunte Drachen`t überlebt.");
                                        ...
                                        output("`4Du wurdest vom `@kunterbunte Drachen`4 gefressen!");
                        ...
                        break;
                case "cower":
                        output("`tDu kauerst dich vor dem `@kunterbunte Drachen`t zusammen und flehst um dein Leben. Der Drachen schnaubt dir erneut seinen heißen Atem ");
                        ...
                        break;
                case "talk":
                        output("`tDu bist der Meinung, dass du diese Begegnung überleben könntest, wenn es dir gelingt, den `@kunterbunte Drachen`t in ein Gespräch zu verwickeln. ");
                        ...
                        addnav("Arda","forest.php?op=city&count=0");
                ...
                case "weather":
                        ...
                        addnav("Arda","forest.php?op=city&count={$count}");
                ...
                case "city":
                        $count=$HTTP_GET_VARS['count'];
                        $count++;
                        output("`t\"`qWusstest du, dass das Dorf Arda heißt? Ist ein ziemlich beeindruckendes Örtchen!`t\"`nDer Drachen gröhlt laut.`n\"`5Diese stinkende Stadt ist mir ");
