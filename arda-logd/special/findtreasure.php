...
if ( $HTTP_GET_VARS[op] == "baum"){
        ...
        if ($session[user][turns]<1){
                ...
                $runden2 = round($runden/4);
                output("`n`2Auf der Suche nach dem `4X`2 auf der Karte verbrauchst du `@$runden2 `2Waldkämpfe. Schliesslich findest du die Stelle ");
                ...
                $foundgold = 1000 * e_rand(1,$runden) * $session['user']['level'];
