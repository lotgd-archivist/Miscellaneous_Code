        ...
        */
        ...
        if ($session[user][seenmaster]==1){
            ...
            if ($session[user][experience]>=$exprequired){
                ...
                output("Du machst dich mit ".$session[user][weapon]." `0und ".$session[user][armor]." `0bereit und näherst dich Meister `^$master[creaturename]`0.`n`nEine kleine Menge Zuschauer ");
                ...
                output("Kleinlaut nimmst du ".$session[user][weapon]." `0entgegen und schleichst unter dem schallenden Gelächter der Zuschauer vom Trainingsplatz.");
                addnav("Zurück zur Klingengasse","klingengasse.php");
                addnav("Warchilds Akademie","academy.php");
                $session[user][seenmaster]=1;
            }
