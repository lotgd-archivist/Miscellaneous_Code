...
output ("`4Du darfst erst nach einem Phoenixkill dein Glück erneut versuchen...verschwinde du Wurm!!");
addnav("Zurück","village.php");
}else{
        output("`c`n<img src='images/1_geisterschloss.jpg' width='358' height='269'>`c`n",true);
...
case 5:
                   // addnav("Ort verlassen","village.php");
                    output("als dich ein Funkeln in einer offnen Schatzkiste anfunkelt, läufts du daran vorbei und siehst einige Edelsteine und nimmst sie an dir!");
