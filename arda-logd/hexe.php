...
if ($_GET[op] == "wkkauf"){
    ...
    output("\"`%Hiermit erhältst du die Möglichkeit, des Phoenix erneut aufzuspüren. Doch diesmal mache es richtig!`!\" Sie läßt deine Hand los und die Edelsteine sind verschwunden.`n");
    output("Du kannst deinen letzten Waldkampf jetzt dem Kampf gegen den Phoenix widmen...`n`n");
    $session[user][gems]-=3;
    ...
    if ($session[user][witch]<getsetting("witchvisits",3)){
        ...
        if ($session[user][seendragon] && $session[user][gems]>2 && $session[user][turns]>0 && $session[user][level]>=15) addnav("Neue Phoenixsuche (3 Edelsteine)","hexe.php?op=Phoenix");
