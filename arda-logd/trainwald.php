...
//    $exparray=array(1=>100,300,602,1012,1540,2207,3041,4085,5395,7043,9121,11740,15037,19171,24330);
    ...
    if ($HTTP_GET_VARS[op]==""){
        ...
        addnav("Meister befragen","trainwald.php?op=question");
        addnav("Meister herausfordern","trainwald.php?op=challenge");
        /*
        if ($session['user']['superuser'] > 2) {
            addnav("Superuser Level erhöhen","trainwald.php?op=challenge&victory=1");
        }
        */
...
*/
        ...
        addnav("Gegen den Meister antreten","trainwald.php?op=challenge");
