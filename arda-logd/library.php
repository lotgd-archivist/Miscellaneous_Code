...
page_header("Ardas Bibliothek");
output("`c`b`9Ardas Bibliothek des gesammelten Wissens in ".($books['anz']==1?'einem Band':$books['anz'].' Bänden')."`0`b`c`n");
...
default:
    ...
    Phoenixleder-Sesseln sitzen eifrige Kämpfer, um zu lesen.`n
    An ein paar Tischen kannst du hin und wieder auch sehr erfahrene Phoenixtöter finden,
