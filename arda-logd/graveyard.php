...
if ($_GET['op']==""){
        ...
        output("`c<img src='images/ramius.jpg' alt='' >`c`n",true);
...
output("`\$Ramius `(sieht dich kurz schief an: `7Wenn du heute nicht mehr zu tun hast....`(.`n Noch bevor du irgendetwas machen kannst, spürts du schon, wie deine Seele wieder in deinen Körper fließt - jedoch zu erschöpft, um heute noch etwas zu tun!");
