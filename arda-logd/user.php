...
$userinfo = array("Account Info,title", "acctid" => "User ID,viewonly", "login" => "Login", "newpassword" => "Neues Passwort", "emailaddress" => "Email Adresse", "locked" => "Account gesperrt,bool", "banoverride" => "Verbannungen übergehen,bool", "einlass" => "Zulassen,viewonly", "superuser" => "Superuser,enum,0,Standard Spieltage pro Kalendertag,1,Stadtwache,2,Biowächter,3,Mod,4,Admin", "admin" => "Die Klasse des Users,enum,0,Keine Klasse,1,RPG-Chara,2,Mix-Chara,3,Level-Chara,4,Spezielle-Chara", "User Infos,title", "name" => "Display Name", "title" => "Titel (muss auch in Display Name)", "ctitle" => "Eigener Titel (muss auch in Display Name)", "sex" => "Geschlecht,enum,0,Männlich,1,Weiblich",
// we can't change this this way or their stats will be wrong.
// "race"=>"Race,enum,0,Unknown,1,Troll,2,Elf,3,Human,4,Dwarf,5,Echse",
"age" => "Tage seit Level 1,int", "dragonkills" => "Phoenixkills,int", "dragonage" => "Alter beim letzten Phoenixkill,int", "bestdragonage" => "Jüngstes Alter bei einem Phoenixkill,int", "veri" => "Verifizierung (0=Nein 1=Ja),viewonly", "bio" => "Biographie,textarea,50,10", "avatar" => "Avatar,textarea,50,10", "Kindersystem,title", "ssstatus" => "Schwanger?,enum,0,Nein,1,Ja", "ssmonat" => "Schwangerschafts Monat (16 Std),int", "sserzeug" => "ID des Vaters,int", "Werte,title", "level" => "Level,int", "experience" => "Erfahrung,int", "rppunkte" => "Rp-Punkte,int", "hitpoints" => "Lebenspunkte (aktuell),int", "maxhitpoints" => "Maximale Lebenspunkte,int", "turns" => "Runden übrig,int", "playerfights" => "Spielerkämpfe übrig,int", "attack" => "Angriffswert (inkl. Waffenschaden),int", "defence" => "Verteidigung (inkl. Rüstung),int", "spirits" => "Stimmung (nur Anzeige),enum,-2,Sehr schlecht,-1,Schlecht,0,Normal,1,Gut,2,Sehr gut", "resurrections" => "Auferstehungen,int", "alive" => "Lebendig,int", "reputation" => "Ansehen (-50 - +50),int", "Spezialitäten,title", "specialty" => "Spezialität,enum,0,Unspezifiziert,1,Dunkle Künste,2,Mystische Kräfte,3,Diebeskunst", "darkarts" => "`4Stufe  in Dunklen Künsten`0,int", "darkartuses" => "`4^--heute übrig`0,int", "magic" => "`%Stufe in Mystischen Kräften`0,int", "magicuses" => "`%^--heute übrig`0,int", "thievery" => "`^Stufe in Diebeskunst`0,int", "thieveryuses" => "`^^--heute übrig`0,int", "Grabkämpfe,title", "deathpower" => "Gefallen bei Ramius,int", "gravefights" => "Grabkämpfe übrig,int", "soulpoints" => "Seelenpunkte (HP im Tod),int", "Aussehen,title", "schuhe" => "Schuhe,enum,0,Keine,1,Wanderschuhe,2,Sportschuhe,3,Lederstiefel,4,Drachenleder Stiefel", "armband" => "Armband,enum,0,Kein,1,Goldenes Armband,2,Drachen Armband", "klamotten" => "Klamotten,enum,0,Keine,1,Weises Kleid,2,Drachenleder Kleid,3,Schwarzes Jacket,4,Drachenleder Jacket", "frisur" => "Frisur - 0=>Glatze 10=>Kurze Haare

         20=>Normale Länge `n40=>Lange Haare 60=>Lang und Ungeflegt,int", "hairco" => "Haarfarbe,enum,0,Braun,1,Schwarz,2,Blond,3,Grün,4,Pink,5,Rot,6,Blau", "nagel" => "Nägel - 0=>Kurze Nägel 10=>Normale Nägel `n20=>Gepflägte Nägel 40=>Ungeplfegt,int", "nagelco" => "Nagellack,enum,0,Kein,1,Schwarz,2,Gelb,3,Lila,4,Rot,5,Blau,6,Pink, 7,Klarlack", "Ausstattung,title", "gems" => "Edelsteine,int", "gold" => "Bargold,int", "goldinbank" => "Gold auf der Bank,int", "transferredtoday" => "Anzahl Transfers heute,int", "amountouttoday" => "Heute ausgegengener Wert der Überweisungen,int", "weapon" => "Name der Waffe", "weapondmg" => "Waffenschaden,int", "weaponvalue" => "Kaufwert der Waffe,int", "armor" => "Name der Rüstung", "armordef" => "Verteidigungswert,int", "armorvalue" => "Kaufwert der Rüstung,int", "Sonderinfos,title", "house" => "Haus-ID,int", "housekey" => "Hausschlüssel?,int", "marriedto" => "Partner-ID (4294967295 = Violet/Seth),int", "charisma" => "Flirts (4294967295 = verheiratet mit Partner),int", "seenlover" => "Geflirtet,bool", "seenbard" => "Barden gehört,bool", "charm" => "Charme,int", "seendragon" => "Phoenix heute gesucht,bool", "rport" => "Hat RP Ort erstellt,bool", "seenmaster" => "Meister befragt,bool", "usedouthouse" => "Plumpsklo besucht,bool", "fedmount" => "Tier gefüttert,bool", "gotfreeale" => "Frei-Ale (MSB: getrunken - LSB: spendiert),int", "hashorse" => "Tier,enum$mounts", "boughtroomtoday" => "Zimmer für heute bezahlt,bool", "drunkenness" => "Betrunken (0-100),int", "avatar" => "Avatar:", "jobid" => "Jobid", "jobname" => "Jobname", "Inquisition,title", "master" => "Masterid(wenn sklave),int", "slave" => "Sklavenid( wenn Meister),int", "erlaubniss" => "Hat Ausgangserliss,int", "Weitere Infos,title", "beta" => "Nimmt am Betatest teil,viewonly", "slainby" => "Gekillt von Spieler,viewonly", "laston" => "Zuletzt Online,viewonly", "lasthit" => "Letzter neuer Tag,viewonly", "lastmotd" => "Datum der letzten MOTD,viewonly", "lastip" => "Letzte IP,viewonly", "uniqueid" => "Unique ID,viewonly", "gentime" => "Summe der Seitenerzeugungszeiten,viewonly", "gentimecount" => "Seitentreffer,viewonly", "allowednavs" => "Zulässige Navigation,viewonly", "dragonpoints" => "Eingesetzte Phoenixpunkte,viewonly", "bufflist" => "Spruchliste,viewonly", "prefs" => "Einstellungen,viewonly", "lastwebvote" => "Zuletzt bei Top Wep Games gewählt,viewonly", "donationconfig" => "Spendenkäufe,viewonly");
...
elseif ($_GET[op] == "edit") {
    ...
    if ($session[user][login] == "Ellalith" or $session[user][login] == "Kibarashi" or $session[user][login] == "Viconia") {
        addnav("User Verifizieren", "user.php?op=veri&userid=$_GET[userid]");
    }
    if (ac_check($row)) {
        output("`\$`bNicht schummeln!!`b Du darfst deinen eigenen Charakter nicht verändern!`0");
    }
    else {
    ...
    output("<br>", true);
    output("<br>", true);
    output("Falls hier ein Bild zu sehen ist , wartet dieses Bild auf die Freigabe eines Teammitglieds :");
    output("<br>", true);

    $sqlname = "SELECT login from accounts WHERE acctid='$_GET[userid]'";
    $userresult = db_query($sqlname);

    if (db_num_rows($userresult) > 0) {

        $avatarinternURL = $_SERVER{'DOCUMENT_ROOT'} . "/avatare/neu/avatar-";
        $avatarURL = "http://arda-logd.com/avatare/neu/avatar-";
        $testRow = db_fetch_assoc($userresult);
        $username = $testRow['login'];
        // output ( "<br>", true );

        if (file_exists($avatarinternURL . $username . ".jpg")) {
            output("<img src='$avatarURL$username.jpg' alt='avatar-$username.jpg'><br>", true);
            addnav("Avatar annehmen", "user.php?op=annehmen&userid=$_GET[userid]");
            addnav("Avatar ablehnen", "user.php?op=ablehnen&userid=$_GET[userid]");
        }
        else if (file_exists($avatarinternURL . $username . ".gif")) {
            output("<img src='$avatarURL$username.gif' alt='avatar-$username.gif'><br>", true);
            addnav("Avatar annehmen", "user.php?op=annehmen&userid=$_GET[userid]");
            addnav("Avatar ablehnen", "user.php?op=ablehnen&userid=$_GET[userid]");
        }
        else if (file_exists($avatarinternURL . $username . ".png")) {
            output("<img src='$avatarURL$username.png' alt='avatar-$username.png'><br>", true);
            addnav("Avatar annehmen", "user.php?op=annehmen&userid=$_GET[userid]");
            addnav("Avatar ablehnen", "user.php?op=ablehnen&userid=$_GET[userid]");
        }
        else if (file_exists($avatarinternURL . $username . ".JPG")) {
            output("<img src='$avatarURL$username.JPG' alt='avatar-$username.JPG'><br>", true);
            addnav("Avatar annehmen", "user.php?op=annehmen&userid=$_GET[userid]");
            addnav("Avatar ablehnen", "user.php?op=ablehnen&userid=$_GET[userid]");
        }
            ...
            output("User Hat kein Bild zum freigeben `n");
        }
    }
    else {
        output("nichts gefunden `n");
    }
    output("<br>", true);
...
elseif ($_GET[op] == "annehmen") {
    ...
    if (db_num_rows($userresult) > 0) {
        ...
        $avatarinternURL = $_SERVER{'DOCUMENT_ROOT'} . "/avatare/neu/avatar-";
        $avatarinternnURL = $_SERVER{'DOCUMENT_ROOT'} . "/avatare/avatar-";
        $rowtest = db_fetch_assoc($userresult);
        $username = $rowtest['login'];

        if (file_exists($avatarinternURL . $username . ".jpg")) {
            copy($avatarinternURL . $username . ".jpg", $avatarinternnURL . $username . ".jpg");
            $test = "UPDATE accounts set avatar = 'avatar-$username.jpg' WHERE acctid='$_GET[userid]'";
            unlink($avatarinternURL . $username . ".jpg");
        }
        else if (file_exists($avatarinternURL . $username . ".gif")) {
            copy($avatarinternURL . $username . ".gif", $avatarinternnURL . $username . ".gif");
            $test = "UPDATE accounts set avatar = 'avatar-$username.gif' WHERE acctid='$_GET[userid]'";
            unlink($avatarinternURL . $username . ".gif");
        }
        else if (file_exists($avatarinternURL . $username . ".png")) {
            copy($avatarinternURL . $username . ".png", $avatarinternnURL . $username . ".png");
            $test = "UPDATE accounts set avatar = 'avatar-$username.png' WHERE acctid='$_GET[userid]'";
            unlink($avatarinternURL . $username . ".png");
        }
        else if (file_exists($avatarinternURL . $username . ".JPG")) {
            copy($avatarinternURL . $username . ".JPG", $avatarinternnURL . $username . ".JPG");
            $test = "UPDATE accounts set avatar = 'avatar-$username.JPG' WHERE acctid='$_GET[userid]'";
        ...
        db_query($test);
        output($test);
        output("`nAvatar wurde angenommen`n");
    }
}
elseif ($_GET[op] == "ablehnen") {
    ...
    if (db_num_rows($userresult) > 0) {
        ...
        if (file_exists($avatarinternURL . $username . ".jpg")) {
            ...
            unlink($avatarinternURL . $username . ".PNG");
                ...
                output("`nAvatar wurde entfernt`n");
...
elseif ($_GET[op] == "veri") {
    ...
    $sqlname = "SELECT veri from accounts WHERE acctid='$_GET[userid]'";
    ...
    if (db_num_rows($userresult) > 0) {
        $testrow = db_fetch_assoc($userresult);
        $veri = $testrow['veri'];
        // output("Veri ist : " .$veri);
        if ($veri == '0') {
            $sqlname = "UPDATE accounts set veri = '1' ,einlass = '1' ,hashorse = '7' WHERE acctid='$_GET[userid]'";
            db_query($sqlname);
            output("User wurde Verifiziert");
            systemmail($_GET[userid], "Herzlich Willkommen", "Hallo und herzlich Willkommen auf Arda.\n\n
Da deine Registrierung mit der Verifikation abgeschlossen ist,\n
haben die Götter als Geschenk -oder Scherz?- beschlossen,\n
dir als kleine Hilfe für den Anfang eine Schachtel ardenische Schlammhüpfer zu überreichen.\n\n
Als Hinweis für den Anfang geben sie dir noch ein paar Ratschläge mit auf den Weg:\n
-Besuch mal die Zwergenstadt, um dich auszurüsten.\n
-Am Hafen in Arda kann man, wenn man genug Gold dabei hat, die tollsten Tiere sehen und kaufen.\n
-Dein Gold auf der Bank bleibt erhalten.\n
-Dein Chatname entspricht deinem Charakternamen hier in Game\n
-Bitte melde dich auch im Forum an. Dort findet man neben allgemeinen Infos auch Biohilfen im Bereich Informationen.");
        }
        else {
            output("User war schon Verifiziert");
        }
    }
}
elseif ($_GET[op] == "special") {
    if ($_POST[newday] != "") {
        if (ac_check($row)) {
            output("`\$`bNicht schummeln!!`b Du darfst deinen eigenen Charakter keinen neuen Tag gewähren!");
        }
        else {
...
elseif ($_GET[op] == "save") {
    ...
    if ($_POST['oldname'] != $_POST['name']) {
        ...
        if (substr_count($clearedname, $_POST['login'])) {
            ...
            if ($_POST['ctitle'] == '')
                $_POST['title'] = '';
            elseif ($_POST['ctitle'] == $_POST['title'])
                $_POST['ctitle'] = '';
        }// Neuer Login
        else {
    ...
    elseif ($_POST['oldlogin'] != $_POST['login']) {
        if ($_POST['ctitle'] != '')
            $_POST['name'] = $_POST['ctitle'] . ' ' . $_POST['login'];
        else
            $_POST['name'] = $_POST['title'] . ' ' . $_POST['login'];
    }// Titel geändert
    elseif ($_POST['oldtitle'] != $_POST['title'] && $_POST['ctitle'] == '') {
        if ($_POST['oldctitle'] != '')
            $colname = str_replace($_POST['oldctitle'], '', $_POST['name']);
        else
...
elseif ($_GET[op] == "") {
    if (isset($_GET['page'])) {
        ...
        for ($i = 0; $i < db_num_rows($result); $i++) {
            ...
            if ($session[user][login] == "Ellalith" or $session[user][login] == "Kibarashi") {
                output("|" . "<a href='user.php?op=del&userid=$row[acctid]' onClick=\"return confirm('Willst du diesen User wirklich löschen?');\">Del</a>", true);
            }
            output("|" . "<a href='user.php?op=setupban&userid=$row[acctid]'>Ban</a>|" . "<a href='user.php?op=debuglog&userid=$row[acctid]'>Log</a>]", true);
