...
{
     case '':
          $out .='Trage hier deine Personalausweis Nummer ein, diese wird benötigt um dein Alter zu errechnen, dein Alter kann nur von Administratoren eingesehn werden, die Altersabfrage dient dem Zweck um minderjährige vor "cyber sex" und erotischen Inhalten auf dieser Seite zu schützen. Leider ist dies NUR mit Deutschen Ausweisen möglich! Solltest du trotzdem eine Verifizierung wünschen so meld dich beim Admin';
          $out .="`n<form action='perso.php?op=set' method='post'>
    ...
    //zahlen mutiplizieren & kontrollieren
          if ($go ==4){
               ...
               else
               {
                   ...
                   addnav("Keine Angaben machen","village.php");
                   addnav("Nochmal versuchen","perso.php");
               }
          }
          else
          {
