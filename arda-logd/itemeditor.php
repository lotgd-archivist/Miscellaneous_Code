...
function itemform($item){
    ...
    $output.="<table>";
    $output.="<tr><td>Item Name:</td><td><input name='item[name]' value=\"".htmlentities($item['name'])."\" maxlength='125'></td></tr>";
    $output.="<tr><td>Item Beschreibung:</td><td><input name='item[description]' value=\"".htmlentities($item['description'])."\" maxlength='510'></td></tr>";
