...
//    if ($session[user][gold]>$cost){ // Eric Stevens
    ...
    checkday();
    page_header("Zigeunerzelt");
    output("`5Du betrittst das Zigeunerzelt hinter dem `WFr`eeu`\$den`eha`Wus`5, welches eine Unterhaltung mit den Verstorbenen verspricht. Im typischen Zigeunerstil sitzt eine alte Frau hinter 
    ...
    if (getsetting("selledgems",0)<300 && $session[user][level]>1) addnav("Verkaufe 1 Edelstein für $scost Gold","gypsy.php?op=sell");
    */addnav("Zurück");
