...
            
output("`n`8Shira segnet dich und du bekommst 5 extra Waldkämpfe!.`n");
            
        
}else if ($session['user']['gott']==1){
            output("`n`8Dein Mut pocht in dir und stolz singst du das Lied von Sharem!.`n");
            
        
}else if ($session['user']['gott']==3){
            output("`n`8Kiri führt deine Hand! Du fühlst dich grossartig.");
            
        
}else if ($session['user']['gott']==4){
            
            output("`n`9Du singst dein Lied von Shiana und spürst ihr Gold in deine Börse fliessen!.");
            
