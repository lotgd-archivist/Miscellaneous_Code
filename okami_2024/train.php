...
checkday();
$session[user][standort]="training";
...
    if ($master['picture']!="" && file_exists($master['picture'])) output("<img src='".$master['picture']."' title='' alt='' />`n",true);
