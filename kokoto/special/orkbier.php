...
//Etwas abgeändert von Tidus für www.kokoto.de

if (!isset($session)) exit();

if ($_GET['op']=='drink'){ // trinken
if ($session['user']['drunkenness']<=74){
    ...
    $session['bufflist']['orkbier'] = $buff = array( "name" => "`^Orkbier","roundmsg" => "Du spürst das Orkbier!","wearoff" => "Du bist wieder einigermaßen nüchtern.","rounds" => "15","atkmod" => "1.1","defmod" => "1.1","activate" => "offense,defense");
    $session['user']['specialinc']='';
    
    }else{
    output('Da du schon so betrunken bist das du kaum stehen kannst überlegst du es dir anders...');
    $session['user']['specialinc']='';
    }
