...
switch($_GET['op']){
  ...
  case 'klopf':
    ...
    switch(mt_rand(1,5)){
        ...
        break;
        case 2:
          $session['user']['gold']+=mt_rand(1,100);
    ...
    case 'labory':
      $session['user']['specialinc']='zweistein.php';
        ...
        rawoutput("<a href='forest.php?op=mix&col=red'><img src='./images/t_red."._type_."' border='0'></a> ");
        rawoutput("<a href='forest.php?op=mix&col=blue'><img src='./images/t_blue."._type_."' border='0'></a> ");
        rawoutput("<a href='forest.php?op=mix&col=green'><img src='./images/t_green."._type_."' border='0'></a> ");
        rawoutput("<a href='forest.php?op=mix&col=yellow'><img src='./images/t_yellow."._type_."' border='0'></a> ");
        rawoutput("<a href='forest.php?op=mix&col=dgreen'><img src='./images/t_dgreen."._type_."' border='0'></a> ");
        rawoutput("<a href='forest.php?op=mix&col=brown'><img src='./images/t_brown."._type_."' border='0'></a> ");
    ...
    case 'mix':
      $session['user']['specialinc']='zweistein.php';
        ...
        if($_GET['col']!="red") rawoutput("<a href='forest.php?op=mix2&col=red&col2=".$_GET['col']."'><img src='./images/t_red."._type_."' border='0'></a> "); 
		allownav("forest.php?op=mix&col=red&col2=".$_GET['col']);
		
        if($_GET['col']!="blue") rawoutput("<a href='forest.php?op=mix2&col=blue&col2=".$_GET['col']."'><img src='./images/t_blue."._type_."' border='0'></a> ");
        if($_GET['col']!="green") rawoutput("<a href='forest.php?op=mix2&col=green&col2=".$_GET['col']."'><img src='./images/t_green."._type_."' border='0'></a> ");
        if($_GET['col']!="yellow") rawoutput("<a href='forest.php?op=mix2&col=yellow&col2=".$_GET['col']."'><img src='./images/t_yellow."._type_."' border='0'></a> ");
        if($_GET['col']!="dgreen") rawoutput("<a href='forest.php?op=mix2&col=dgreen&col2=".$_GET['col']."'><img src='./images/t_dgreen."._type_."' border='0'></a> ");
        if($_GET['col']!="brown") rawoutput("<a href='forest.php?op=mix2&col=brown&col2=".$_GET['col']."'><img src='./images/t_brown."._type_."' border='0'></a> ");
        ...
        ////////////////////////////////////////////////////////////////////////////////////
                if(!$explode){
                  ...
                  addnav('Der Wald','forest.php');
                    ...
                    rawoutput("<img src='./images/t_explode."._type_."'>");
                    ...
                    if(mt_rand(1,2)==1){
                      ...
                      output('`nDurch die Explosion stirbst du!`n`Du verlierst 3% deiner Erfahrung.');
