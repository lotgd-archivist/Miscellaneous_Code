...
if ($_GET['op']=='return') {
	...
	output('`n`2Du atmest tief durch, schließt die Augen und streckst deine Hände weit weg von deinem Körper. Du bietest dich der Hexe förmlich an.`nWenige Sekunden danach hat die Hexe ihren Zauberspruch beendet und saugt dir das Leben aus.`n`n`4`bDir wird schwindlig und du fällst zu Boden, dein Leben ist nun vollkommen ausgesaugt.`b`n`nEine weitere Leiche liegt nun hinter dem Baum.');
	...
	switch(mt_rand(1,4)){
		case '1':
		case '2':
		output('`n`2Du holst tief Luft und näherst dich den Leichen.`n`2Als du dich den Leichen näherst, hörst du, wie hinter dir ein Ast bricht, du ziehst deine Waffe und drehst dich sofort um.`0`n`n`3Eine alte Frau in schwerem Gewand steht dir gegenüber und murmelt etwas vor sich hin, in einer Sprache die du nicht verstehst.`0`n`n`2Als du das Wort ergreifst, schaut sie aus der Leere direkt in deine Augen. "`8Kann ich Euch behilflich sein?`2" Fragst du nervös.`n`2"`6Wie kann mir jemand helfen, der selbst Hilfe nötig hat? Aber wenn Ihr darauf besteht, ich nehme gerne das was Ihr noch habt. Euer Leben!`2" Erwiedert die Frau.`0`n`n`3Die Frau fängt an zu kichern und fuchtelt mit den Händen in der Luft herum, murmelt wieder etwas in der Sprache vor sich hin, die du nicht kennst`0`n');
		$session['user']['specialinc']='graeultat.php';
		addnav('Sich der Hexe stellen','forest.php?op=dead');
		...
		case '3':
		case '4':
		output('`n`2Du holst tief Luft und näherst dich den Leichen.`n`2Als du eine der Leichen auf die Seite rollst, faucht dich erstmal eine Ratte an, verschwindet aber gleich.`n`n`^Du findest 1 Edelstein.`0');
		$session['user']['gems']+=1;
		$session['user']['specialinc']='';
		break;
	}
	...
	output('`n`c`b`#Überkommende Übelkeit`b`c`n`n`2Als du dich auf die Suche nach einem Abenteuer begiebst, wird dir plötzlich schlecht, du setzt dich auf den alten Baumstamm in deiner Nähe, kaum als das du sitzt überkommt dich ein Brechreiz, du drehst dich um, schreckst sofort wieder zurück.`2`n`n`2Hinter dem Baumstamm liegen ein paar angenagte und verweste Leiche, deren Gestank wohl deine Übelkeit verursacht hat. Dein Brechreiz siegt und deine letzte Mahlzeit verteilt sich vor deinen Füßen.`2');
	...
	$session['user']['specialinc']='graeultat.php';
	allownav('forest.php?op=look');
	allownav('forest.php?op=return');
