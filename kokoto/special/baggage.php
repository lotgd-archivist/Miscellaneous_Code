...
if(!isset($session['user']['specialinc'])) exit();
  ...
  output('Du folgst dem Kobold über mehrere Minuten hinweg, als ihr plötzlich an einer Lichtung ankommt.
  ...
  default:
    $session['user']['specialinc']='baggage.php';
  output('Du bemerkst auf deinen Streifzügen durch den Wald einen kichernden Kobold.`n
