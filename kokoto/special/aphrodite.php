...
if ($_GET['op']=='do'){
	...
	if ($session['user']['sex']>0){
		output('`%Du folgst dem Gott in die Büsche. Wenige Minuten später, sind nur noch leise Geräusche zu hören. Als du erwachst, stellst du fest dass ...`n`n`^');
		switch(mt_rand(1,10)){
			case '1':
			case '2':
		...
		output('`%Du folgst der Göttin in die Büsche. Wenige Minuten später, sind nur noch leise Geräusche zu hören. Als du erwachst, stellst du fest dass ...`n`n`^');
		switch(mt_rand(1,10)){
			case '1':
			case '2':
