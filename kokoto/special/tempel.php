...
if ($_GET['op']=='verlassen'){
	...
	if ($_GET['betrag']>$session['user']['gold'])	{
		...
		output("`nAm Geräusch, das deine Goldstücke beim Einwerfen verursachen, vermutest du, dass bisher etwa ".($drinround($drin100mt_rand(3,3)))." gespendet worden sein muss. ");
