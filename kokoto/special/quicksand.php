...
if ($_GET['op']=='wait'){   // auf Hilfe warten
     ...
     switch(mt_rand(0,1)){
         ...
         kannst, dann wirst Du aus Deiner mißlichen Lage herausgezogen.`0 `n`n`3Du musstest etwas auf Hilfe warten und verlierst deswegen einen
         ...
         der Dir zu Hilfe eilen könnte.`0 `n`n`3Du wartest, und wartest, ...... und wartest. `$"Wo bleiben die denn
...
}else if ($_GET['op']=='free'){   // selbst befreien
 ...
 output('`n`8Auf Deinem Weg durch den Wald kommst du an einen kleinen Fluss, denn Du
    ...
    case '3':
    case '4':
    $gold=$session['user']['level']  mt_rand(2,10);
