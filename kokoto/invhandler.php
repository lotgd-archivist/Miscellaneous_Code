...
$sql="INSERT INTO items(name,class,owner,gold,value1,description) VALUES ('".mysql_real_escape_string($session['user']['armor'])."','Rüstung',".$session['user']['acctid'].",".$session['user']['armorvalue'].",".$session['user']['armordef'].",'Gebrauchte Rüstung mit ".$session['user']['armordef']." Verteidigung.')";
...
$sql="INSERT INTO items(name,class,owner,gold,value1,description) VALUES ('".mysql_real_escape_string($session['user']['weapon'])."','Waffe',".$session['user']['acctid'].",".$session['user']['weaponvalue'].",".$session['user']['weapondmg'].",'Gebrauchte Waffe mit ".$session['user']['weapondmg']." Angriffswert.')";
...
if ($session['user']['weaponvalue']<1) $session['user']['weaponvalue']=1;
	...
	db_query("UPDATE items SET class='Möbel',gold=1,gems=0,value1=".$session['user']['house']." WHERE id=".(int)$_GET['id']);
