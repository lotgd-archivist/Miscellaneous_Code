...
if ($_GET['op']=='throwkey' && !isset($_GET['comscroll']) && $_POST['section']=="") {
	...
	db_query('UPDATE items SET owner=0 WHERE class="Schlüssel" AND owner='.$session['user']['acctid'].' AND value1='.(int)$_GET['house']);
...
viewcommentary("well","Mit Umstehenden reden:",10,"sagt");
