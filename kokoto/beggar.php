...
page_header("Bettelstein von Kokoto");
...
output("<input type='submit'value='Spendieren'></form><script language='javascript'>document.getElementById('goldspende').focus();</script>",true);
allownav('beggar.php?op=spenden2');
