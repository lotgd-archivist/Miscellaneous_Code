...
if($_GET['op']=="")
{
        ...
        {
        output("Du gehst dem Weg zu Zeus' Trohn entlang und und triffst endlich auf Zeus, den Göttervater. Er mustert dich mit Erfahrenem Blick und sagt dann: \"`Vich hab schon viel von dir gehört. Ich gewähre dir eine Überraschung.\"`0.`n`nDu kannst dich nun entscheiden. Nimmst du das Angebot an, oder kneifst du?");
...
if($_GET['op']=="we")
{
        ...
        {
                        case '1':
                        output("Zeus nimmt einer seiner Blitze und wirft ihn auf dich. Du erschrickst und rennst davon.`n Wegen deiner Flucht verlierst du an Ehrenhaftigkeit.");
