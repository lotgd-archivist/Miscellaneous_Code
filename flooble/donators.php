...
output("`bAdd Donation Points:`b`nCharacter: <input name='name'> `nPoints: <input name='amt' size='3'>`n<input type='submit' class='button' value='Add Donation'>",true);
output("</form>",true);
...
    output("<tr><td>Name</td><td>Points</td><td>Spent</td></tr>",true);
