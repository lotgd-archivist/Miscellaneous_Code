...
        output('<img src="images/illust/forest.gif" class="picture" align="right">',true);
...
    if (!file_exists("templates/$templatename") || $templatename=="") $templatename="classic.htm";
...
    if ($row[notseen]>0){
        return "<div><a href='mail.php' target='_blank' onClick=\"".popup("mail.php").";return false;\" class='nav'>Mail: $row[notseen] new, $row[seencount] old</a></div>";
    }else{
        return "<div><a href='mail.php' target='_blank' onClick=\"".popup("mail.php").";return false;\" class='nav'>Mail: $row[notseen] new, $row[seencount] old</a></div>";
    }
}
...
    $template=loadtemplate("classic.htm");
}
