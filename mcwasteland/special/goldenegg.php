...
    } else {
        output("`3Die Luft ist rein und du greifst dir das Ei. Sofort spÃ¼rst du, dass dir dieses Ei einigen TÃ¼ren Ã¶ffnen wird und magische FÃ¤higkeiten hat, die sogar den Tod besiegen kÃ¶nnen. Aber dir ist auch klar, dass dieses Ei den Neid vieler anderer Krieger auf sich ziehen wird.");
...
        output("`3Mitten im dichten Wald entdeckst du auf einer starken Astgabel eines gewaltigen Baumes ein riesiges Nest.`nDu bemerkst, dass es leer ist und schenkst ihm keine weitere Aufmerksamkeit.`n`n ");
        $session['user']['specialinc']="";
    }elseif(getsetting("hasegg",0)==0){
          output("`3Mitten im dichten Wald bemerkst du etwas von oben durch die BlÃ¤tter funkeln. Es ist nicht die Sonne! In deiner Neugier kommst du nÃ¤her. Du siehst auf einer starken Astgabel eines gewaltigen Baumes ein riesiges Nest - in dem ein groÃŸes goldenes Ei funkelt!`nDa du keine Ahnung hast, welches Tier solche Eier legt und so riesige Nester baut, bist du unschlÃ¼ssig, ob du schnell nach oben klettern und das Ei mitnehmen sollst, oder es doch lieber dort lassen solltest. Einerseits kÃ¶nnte das Ei magische KrÃ¤fte haben, oder zumindest eine reichliche Mahlzeit bieten - andererseits aber kÃ¶nntest du ebenso verlockend und lecker auf die Mutter dieses Eis wirken...");
...
        if($owner == $row['acctid']){
            output("`3Du kommst an eine Stelle im Wald, die dir merkwÃ¼rdig bekannt vorkommt. PlÃ¶tzlich hÃ¶rst du ein lautes Kreischen Ã¼ber dir in der Luft und ein schnell lauter werdendes Rauschen. Es ist die Greifenmutter, die ihr Ei bei dir wittert!! Du schaffst es gerade noch, ihr das Ei entgegenzustrecken, bevor sie Ã¼ber dich herfÃ¤llt.");
            $lvl = $session['user']['level'];
...
        }else{
            output("`3Mitten im dichten Wald entdeckst du auf einer starken Astgabel eines gewaltigen Baumes ein riesiges Nest.`nDu bemerkst, dass es leer ist und schenkst ihm keine weitere Aufmerksamkeit.`n`n`^Das goldene Ei befindet sich zur Zeit im Besitz von ".$row['name']."`^!`n`3Willst du es ".($row['sex']?"ihr":"ihm")." nicht mal abnehmen?`n");
        }
        $session['user']['specialinc']="";
    }
}
