...
        //output("<embed src='media/cat.wav' width='10' height='10' autostart='true' loop='false' hidden='true' volume='50'>",true);
        output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/cat.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
    }
