...
output("`6\"`3Keine Zeit, keine Zeit!`6\" tÃ¶nt es aus den Baumwipfeln - verwirrt schaust du etwas genauer hin. Ach ja, der Heiler - fleiÃŸig bei der Arbeit.`n`6\"`3Es mir Leid tut, aber absolut keine Zeit fÃ¼r dich ich jetzt habe.`6\" sagt er, als er kurz runterkommt um den nÃ¤chsten Baum hinaufzuklettern.");



if(e_rand(1,100)> 70) {

    output("`6Er steckt dir noch ungefragt einen Coupon fÃ¼r Golinda zu. Du schaust ihn zwar fragend an, wagst es aber nicht, etwas zu sagen. AuÃŸerdem - so Ã¼berlegst du dir - ist Golinda doch ohnehin gÃ¼nstiger.");
