...
    }elseif (getsetting("paidgold","0")+$goldsumme>25000){
...
    }elseif ($goldsumme<$session['user']['level']*2){
...
    }elseif ($session['user']['gold']>=$session['user']['level']*700){
...
    }elseif ($session['user']['goldinbank']>=$session['user']['level']*700){
...
    }elseif (($session['user']['goldinbank']+$session['user']['gold'])>=$session['user']['level']*700){
...
    }elseif (($session['user']['weapondmg']>=15) && ($session['user']['armordef']>=15)){
...
    }elseif ($session['user']['gems']>=$session['user']['level']){
...
    }elseif ($session['user']['housekey']>0){
...
    }elseif (getsetting("paidgold","0")>0){
