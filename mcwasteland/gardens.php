...
        output(($session['user']['sex']?"<img src=\"images/male.png\">":"<img src=\"images/female.png\">")."</td><td><b>Name</b></td><td><b>Level</b></td><td><b>Rasse</b></td><td><b>Status</b><td><b>Ops</b></td></tr>",true);
...
        //output("<embed src=\"media/vogel.wav\" width=10 height=10 autostart=true loop=false hidden=true volume=100>",true);

        output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/vogel.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
