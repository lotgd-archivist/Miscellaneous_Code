...
            $sql="SELECT * FROM items WHERE owner=0 AND (class='Beute.Prot' OR class='Zauber.Prot' OR class='Kleidung.Prot' OR class='Komponente.Prot' OR class='Fauliges.Prot' OR (class='Rezept.Prot' AND (gold>0 OR gems>0))) ORDER BY rand(".e_rand().") LIMIT 1";
...
                }elseif ($row2['class']=="Kleidung.Prot"){
