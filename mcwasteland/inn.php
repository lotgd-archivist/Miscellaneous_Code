...
$buff = array("name"=>"`9Schutz der Liebe","rounds"=>60,"wearoff"=>"`!Du vermisst ".($session['user']['sex']?"Seth":"`5Violet`")."!.`0","defmod"=>1.2,"roundmsg"=>"Deine groÃŸe Liebe lÃ¤sst dich an deine Sicherheit denken!","activate"=>"defense");
...
    output("  Du winkst einigen deiner Kumpels und zwinkerst ".($session['user']['sex']?"`^Seth`0 zu, der seine Harfe beim Feuer stimmt.":"`5Violet`0 zu, die ein paar einheimischen Ale serviert.")." Der Barkeeper Cedrik steht hinter seiner Theke und quatscht mit irgendjemandem. Du kannst nicht genau verstehen was er sagt, aber es ist irgendwas Ã¼ber ");
...
        $msgdate=date("Y-m-d H:i:s",strtotime(date("Y-m-d")." +{$_GET['amt']} days"));
...
                                        output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/giggle.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/ragtime.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/matlock.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/burp.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/indianajones.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/eternal.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/babyphan.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/knightrider.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    output("<audio autoplay preload=\"auto\" id=\"audioLoop\"><source src=\"media/boioing.mp3\" type=\"audio/mp3\">Your browser does not support the audio element.</audio><script>var vid = document.getElementById(\"audioLoop\");vid.volume = 0.3;</script> ",true);
...
                    addnav("`\$Dunkle KÃ¼nste`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=1");

                    addnav("`%Mystische KrÃ¤fte`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=2");

                    addnav("`^DiebeskÃ¼nste`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=3");

                    addnav("`qKampfkunst`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=4");

                    addnav("`#Spirituelle KrÃ¤fte`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=5");

                    addnav("`@Naturkraft`0",preg_replace("/[&?]c=[[:digit:]-]*/","",$REQUEST_URI)."&specialty=6");
...
                        output("Weil du so eine nette Person bist, bietet er dir zum Preis von `\$".$bankexpense."`0 Gold auch an, direkt von der Bank zu bezahlen. Der Preis beinhaltet " . (strpos($fee, "%") ? $fee : "$fee Gold") . " ÃœberweisungsgebÃ¼hr.");
