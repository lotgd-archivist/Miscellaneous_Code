...
    output("`c`b`9News fÃ¼r $date".($totaltoday>$newsperpage?" (Meldungen ".($pageoffset+1)." - ".min($pageoffset+$newsperpage,$totaltoday)." von $totaltoday)":"")."`c`b`0");
...
        output("`9`b`c Es ist nichts erwÃ¤hnenswertes passiert. Alles in allem bisher ein langweiliger Tag. `c`b`0");
