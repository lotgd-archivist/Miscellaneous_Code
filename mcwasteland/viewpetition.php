...
        output("<tr class='".($i%2?"trlight":"trdark")."'><td>".$row['petitionid']."</td><td>[<a href='viewpetition.php?op=view&id=".$row['petitionid']."'>Anzeigen</a>|<a href='viewpetition.php?op=del&id=".$row['petitionid']."' onClick='return confirm(\"Diese Anfrage wirklich lÃ¶schen?\");'>LÃ¶schen</a>|<a href='viewpetition.php?setstat=0&id=".$row['petitionid']."'>Ungelesen</a>|<a href='viewpetition.php?setstat=1&id=".$row['petitionid']."'>Gelesen</a>|<a href='viewpetition.php?setstat=2&id=".$row['petitionid']."'>Geschlossen</a>]</td>",true);
        output("<td>",true);
        if ($row['name']==""){
...
    }
    output("</table>",true);
    output("`i(Geschlossene Anfragen werden nach 7 Tagen automatisch gelÃ¶scht)`i",true);
...
    Wenn eine Anfrage erfolgreich bearbeitet wurde, markiere sie als geschlossen. Sie wird nach 7 Tagen dann automatisch gelÃ¶scht.",true);
}elseif($_GET['op']=="view"){
