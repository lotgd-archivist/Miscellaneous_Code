...
addnav("GetÃ¶tete Monster","hof.php?op=creaturekills&subop=$subop&page=$page");
...
    $sql = "SELECT name,(gemsinbank+gems) AS data1 FROM accounts WHERE locked='0' ORDER BY data1 ".$order.", level ".$order.", experience ".$order.", acctid ".$order." LIMIT ".$limit;
