...
if ($_GET[op]==""){
    ...
    if ($session[user][hitpoints] < $session[user][maxhitpoints]){
        ...
        if ($golinda) {
            output("`3Golinda untersucht dich sehr sorgfältig. \"`6Nun, du hast diesen leicht eingewachsenen Zehennagel hier, aber ansonsten bist du vollkommen gesund. `^Ich`6 glaube, du bist nur hierher gekommen, weil du einsam warst.`3\", kichert sie.`n`nDu erkennst, dass sie Recht hat und dass du sie von ihren anderen Patienten abhältst. Deswegen gehst du zurück in den Wald.");
        } else {
            output("`3Die alte Kreatur schaut in deine Richtung und grunzt: \"`6Einen Heiltrank du nicht brauchst. Warum du mich störst, ich mich frage.`3\" Der Geruch seines Atems lässt dich wünschen, du wärst gar nicht erst gekommen. Du denkst, daß es das Beste ist, einfach wieder zu gehen.");
        }
        forest(true);
    }else{
        if ($golinda) {
