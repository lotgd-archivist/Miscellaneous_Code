...
                $taunt = str_replace_c("%s",($session['user'][gender]?"ihm":"ihr"),$taunt['taunt']);

                $taunt = str_replace_c("%o",($session['user'][gender]?"er":"sie"),$taunt);

                $taunt = str_replace_c("%p",($session['user'][gender]?"sein":"ihr"),$taunt);
