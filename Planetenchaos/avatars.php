...
    systemmail($_GET['userid'],"Dein Avatar wurde entfernt","Der Administrator hat beschlossen, dass dein Avatar unangebracht ist, oder nicht funktionierte, und hat ihn entfernt.`n`nWenn du darÃ¼ber diskutieren willst, benutze bitte den Link zur Hilfeanfrage.");
