...
$specialty=array(0=>"nicht spezifiziert","Dunkle KÃ¼nste","Mystische KrÃ¤fte","Diebeskunst");

//$horses=array(0=>"None","Pony","Gelding","Stallion");

output("`^Biographie fÃ¼r $row['name']");
...
output("`^Geschlecht: `@".($row['sex']?"Weiblich":"MÃ¤nnlich")."`n");
