...
    systemmail($_GET['userid'],"`0Nachricht gelÃ¶scht","`0Ein Administrator hat deine Nachricht vom schwarzen Brett genommen.`n`nWenn du darÃ¼ber diskutieren willst, wende dich an ".$session['user']['name']."`0, oder benutze bitte den Link zur Hilfeanfrage.");
