...
output('`cWillkommen bei Legend of the Green Dragon, schamlos abgekupfert von Seth Ables Legend of the Red Dragon.`n');
...
    $result = db_query('SELECT superuser, uniqueid FROM accounts WHERE uniqueid='.$id.' AND superuser>0'); 
...
        if (!isset($_COOKIE['Planetenchaos']))
...
output('`n`b`&'.getsetting('loginbanner','*BETA* Dies ist eine BETA-Version, alles kann und wird sich verÃ¤ndern *BETA*').'`0`b`n');
