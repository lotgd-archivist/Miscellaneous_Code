...
$sql = "DELETE FROM referers WHERE last<'".date("Y-m-d H:i:s",strtotime(date ("c")."-".getsetting("expirecontent",180)." days"))."'";
...
                output("<a href='".HTMLEntities($row1['uri'])."' target='_blank'>".HTMLEntities(substr_c($row1['uri'],0,150))."</a>`n",true);
