...
                $_POST['subject']=closetags(str_replace_c("`n","",$_POST['subject']),'`c`i`b');

                $_POST['body']=str_replace_c("`n","\n",$_POST['body']);

                $_POST['body']=str_replace_c("\r\n","\n",$_POST['body']);

                $_POST['body']=str_replace_c("\r","\n",$_POST['body']);

                $_POST['body']=addslashes(substr_c(stripslashes($_POST['body']),0,(int)getsetting("mailsizelimit",1024))); 
...
                $_POST['body']=substr_c($_POST['body'],0,(int)getsetting("mailsizelimit",1024));
...
        output("<input type='submit' class='button' value='Markierte lÃ¶schen'>",true);
...
        output("<a href='mail.php?op=write&replyto=$row[messageid]' class='motd'>Antworten</a><a href='mail.php?op=del&id=$row[messageid]' class='motd'>LÃ¶schen</a>",true);
...
            if (substr_c($subject,0,4)!="RE: ") $subject="RE: $subject";
