...
        if (!strpos_c($session['user']['specialmisc'],"_swim")) addnav("Im See schwimmen","forest.php?op=swim");

        if (!strpos_c($session['user']['specialmisc'],"_music")) addnav("Musizieren","forest.php?op=music");

        if (!strpos_c($session['user']['specialmisc'],"_picknick")) addnav("Picknicken","forest.php?op=picknick");

        if (!strpos_c($session['user']['specialmisc'],"_flirt")) addnav("Plaudern","forest.php?op=flirt");

        if ($loverHorseID+$lovedHorseID>0 && !strpos_c($session['user']['specialmisc'],"_ride") ) addnav("Ausreiten","forest.php?op=ride");
...
        if ($loverHorseID+$lovedHorseID>0 && !strpos_c($session['user']['specialmisc'],"ride") ) addnav("Ausreiten","forest.php?op=ride");
