...
            if (strtolower_c(substr_c($session['user']['name'],-1))=="s") addnews($session['user']['name']."s Überreste waren nicht sehr schön als sie gefunden wurden..."); 
...
        $taunt = str_replace_c("%s",($session['user']['sex']?"her":"him"),$taunt['taunt']); 

        $taunt = str_replace_c("%o",($session['user']['sex']?"she":"he"),$taunt); 

        $taunt = str_replace_c("%p",($session['user']['sex']?"her":"his"),$taunt); 
