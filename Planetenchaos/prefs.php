...
            if ($url>"" && strpos_c($url,".gif")<1 && strpos_c($url,".GIF")<1 && strpos_c($url,".jpg")<1 && strpos_c($url,".JPG")<1 && strpos_c($url,".png")<1 && strpos_c($url,".PNG")<1){
...
                output("<input type='radio' name='template' value='$val'".($_COOKIE['template']==""&&$val=="yarbrough.htm" || $_COOKIE['template']==$val?" checked":"").">".substr_c($val,0,strpos_c($val,".htm"))."<br>",true);
