...
                if (substr_c($_SERVER['REMOTE_ADDR'],0,strlen_c($var)) == $var){
...
            if (strlen_c($row['reason'])>50) $row['reason'] = substr_c($row['reason'],0,47).'...';
...
            deleteuser($var,$_POST['stdreason'],$_POST['reason'],$_POST['savereason']);
...
            $tmpstr .= ('<tr><td><input type="checkbox" name="userid[]" value="'.$var['acctid'].'"></td>
