...
        (laston > '".date("Y-m-d H:i:s",strtotime(date('c')."-346000 sec"))."' OR (charisma=4294967295 AND acctid=".$session['user']['marriedto'].") )
