...
    "superuser"=>"Default superuser level,$rank",
    "newplayerstartgold"=>"Gold mit dem ein neuer Char startet,int",
    "newplayerstartgems"=>"Edelsteine mit dem ein neuer Char startet,int",
...
      "Gildensystem,title",
    "gilden_dkrequired"=>"Mindest Drachenkillanzahl welche benötigt wird um eine Gilde zu gründen,int",
...
    "gilden_highestleader"=>"Höchste Leaderid (Leaderkennungszahl,int",
...
    "gilden_maxweapons"=>"Lagergrösse für Waffen,int",
    "gilden_maxarmors"=>"Lagergrösse für Rüstungen,int",
...
    'ERSV_DEFFILESTAT' => 'Neue Dateien sind bei aufnahme,enum,open,Geöffnet,blocked,Blockiert',
    'ERSV_DEFDIRSTAT' => 'Neue Verzeichnisse Standardgemäss aktiviert?, bool',
    'ERSV_FILETYPES' => 'Die hier gelisteten Dateierweiterungen werden beim crawlen eingefangen (Bitte keine Binärdateien wie Bilder!!!)',
...
    "Nächster neuer Tag: ".date("h:i:s a",strtotime(date("c")."+$realsecstotomorrow seconds")).",viewonly",
