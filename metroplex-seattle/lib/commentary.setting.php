...
 */
define('COMMENTARY_TEXTAREA_SHOWCHARS', true);
...
 */
define('COMMENTARY_MAXLENGHT', 10000);
...
 */
define('COMMENTARY_FARBHACK_IS_INSTALLED', true);


define('SHOW_EDITBUTTON', $session['user']['prefs']['editbutton']?false:true); #für den Editbutton"
...
 */
define('COMMENTARY_NAVIGATION_POSITION', 'both');
...
 */
define('COMMENTARY_TIMESTAMP_FORMAT', 'd.m H:i');
...
/**
 * Template für den HTML-Link zur Popup - Biographie, {LOGIN}, {REQUESTURI}, {ACCTID}, {NAME}, {POPUP}
 * @const COMMENTARY_BIO_LINKTEMPLATE
 */
define('COMMENTARY_POPUPBIO_LINKTEMPLATE', "`0<a href=\"biopopup.php?char={LOGIN}\" target=\"_blank\" style=\"text-decoration: none\">\r\n`&{NAME}`0</a>\r\n"); # Der Link mit Name (Anzeige) für die Bio. Geparst wird: {LOGIN}, {REQUESTURI}, {ACCTID}, {NAME}, {POPUP}
...
/**
 * Template für den BioPopup Link selbst (für die Whitelist), geparst wird {LOGIN}, {REQUESTURI}, {ACCTID}
 * @const COMMENTARY_BIO_LINK
 */
define('COMMENTARY_POPUPBIO_LINK', 'biopopup.php?char={LOGIN}'); # Der reine Link (Whiteliste der Navigation) für die Bio. Geparst wird: {LOGIN}, {REQUESTURI}, {ACCTID}
/**
...
 */
define('COMMENTARY_DISPLAYEMOTLERNAME_SULEVEL', 0); # 
...
 *  opsizi => Für das Opscenum-Sizilien-System
 * @const COMMENTARY_USE_RPPOINTS
 */
define('COMMENTARY_USE_RPPOINTS', 'wintertal');
...
 */
define('COMMENTARY_USE_RPCMD', 'meteora');
