...
                output("`n`nDu brichst am Rande des Stroms zusammen. Dabei erkennst du erst jetzt gerade noch, dass die Steine, die dir aufgefallen sind ");
...
                addnews("`&".$session[user][name]." `7hat seltsame Kräfte im Wald entdeckt und wurde nie wieder gesehen.`0");
            break;
            case 2:
        output("`igefolgt von einer bedrohlichen, beklemmenden Kälte`i. Du taumelst und greifst dir an die Brust. Du fühlst das, was ");
                output("du dir als die Hand des Sensenmanns vorstellst, der seinen gnadenlosen Griff um dein Herz legt.");
