...
        }else{
            output("`n`2Du hältst diesen Schwächeanfall für ein Zeichen, heute besser keine weiteren Gegner mehr im Wald zu erschlagen.`n`");
...
    output("`n`2Du beschließt, so schnell wie möglich von hier weg zu rennen, auf deiner Flucht stürzt du ein paar mal und verletzt dich. Als du meinst in Sicherheit zu sein, drehst du dich um und erschreckst dich fast zu Tode: die alte Frau steht hinter dir und ist nicht einmal außer Atem.`n`n");
...
    $session[user][specialinc]="";
    addnews("`&".$session[user][name]." `9wurde von einer Hexe getötet.");
