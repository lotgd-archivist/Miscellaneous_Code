...
break; 
case 9: 
output("`7Während du den Vorsprung entlang gehst, rutschst du aus, fällst hinab,`n"); 
output("prallst von einigen Steinen unter dir ab und landest schlussendlich im Wasser!`n`n"); 
...
addnews("`&".$session[user][name]."'s `jzerschundener Körper wurde, teils von Steinen begraben, unter einem Wasserfall gefunden."); 
...
output("dich, lieber auf dem Hauptweg zu bleiben und siehst zu, dass du zügig Abstand zu dem mysteriösen Pfad gewinnst."); 
$session[user][specialinc]=""; 
break; 
