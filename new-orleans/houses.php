...
            
        viewcommentary("jacksonsquare_kreolischevillen","HinzufÃ¼gen:`0");
        }

        if ($session['user']['specialmisc']['locid'] == 2) {

        viewcommentary("moonwalk_hausboote","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 3) {

        viewcommentary("royalstreet_bungalows","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 4) {

        viewcommentary("upperwards_apartmentkomplex","HinzufÃ¼gen:`0");
...
        viewcommentary("uptown_gardendistrict_villen","HinzufÃ¼gen:`0");
        }

        if ($session['user']['specialmisc']['locid'] == 6) {

        viewcommentary("bayou_wohnsiedlung","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 7) {

        viewcommentary("centralcity_wohnungen","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 8) {

        viewcommentary("gentilly_campus_wohnheim","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 9) {

        viewcommentary("mythalgiers_hellesviertel_wohnviertel","HinzufÃ¼gen:`0");

        }

        if ($session['user']['specialmisc']['locid'] == 10) {

        viewcommentary("mythalgiers_dunklesviertel_wohnviertel","HinzufÃ¼gen:`0");
...
        viewcommentary("americanquarter_lafayettesquare","HinzufÃ¼gen:`0");
