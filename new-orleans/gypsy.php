...
addcommentary();
$session['user']['standort'] = "Zigeunerzelt";
place();
...
        addnav("zum kleinen Platz","market_places.php");
...
output("Der Preis ist `g$cost`] Gold.
Die Zigeunerin `SVessa`] gibt dir auch zu verstehen, dass sie mit Edelsteinen handelt. Momentan hat sie `g".getsetting("selledgems",0)." `2Edelst`ûeine a`áuf La`Zger.");
    if (getsetting("selledgems",0)>=1000) output("`ZSie`á sche`ûint ab`2er kein`] Interesse an weiteren Edelsteinen zu haben. Oder sie hat einfach kein Gold mehr, um weitere `2Edelst`ûeine z`áu kau`Zfen.");
...
viewcommentary("Zigeuner","Unterhalte dich mit Vessa:`n`n");
