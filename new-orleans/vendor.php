...
        $sql="SELECT * FROM items WHERE owner=0 AND (class='Schmuck' OR class='Möbel.Prot') ORDER BY $sorti ASC LIMIT $limit";
        $result=db_query($sql);
...
    addnav("zum French Market","market_places.php");
        addnav("zum Old French Market","markt.php");
...
    output(" selbst hin und wieder Handel mit ihm betreibt, lässt er ihn gewähren.`nNeugierig näherst du dich dem Wagen, um zu sehen, ob der Händler diesmal etwas Interessantes");
