...
    addnav("Zurück nach necron","necron.php"); 
    addnav("Spiele"); 
    addnav("G?Spiele Glücksrad", "necron_casino.php?op=rad"); 
    addnav("K?Spiele höchste Karte", "necron_casino.php?op=highcard"); 
    addnav("6?Spiele Super 6", "supersix.php"); 
    addnav("W?Spiele Würfel", "necron_casino.php?op=slots"); 
    addnav("H?Spiele Hütchen", "necron_casino.php?op=hut"); 
...
        if ($HTTP_GET_VARS[cost] == "pay" ) redirect("necron_casino.php?op=rad&action=spiel"); 
...
    } 
    addnav("Nochmal spielen","necron_casino.php?op=rad"); 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach Necron","necron.php"); 
}else{ 
...
    addnav("$cost Gold auf `\$Rot", "necron_casino.php?op=rad&cost=pay&color=Rot"); 
    addnav("$cost Gold auf `&Weiss", "necron_casino.php?op=rad&cost=pay&color=Weiss"); 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach necron","necron.php"); 
} 
...
    addnav("Einsatz 10", "necron_casino.php?op=highcard&action=play&bet=10"); 
    addnav("Einsatz 100", "necron_casino.php?op=highcard&action=play&bet=100"); 
    addnav("Einsatz 250", "necron_casino.php?op=highcard&action=play&bet=250"); 
    addnav("Einsatz 500", "necron_casino.php?op=highcard&action=play&bet=500"); 
    addnav("Einsatz 1000", "necron_casino.php?op=highcard&action=play&bet=1000"); 

    } 
    if($HTTP_GET_VARS[action] == "play" && $bet && $enough) 
    { 
    addnav("Nochmal spielen", "necron_casino.php?op=highcard&action=play"); 
...
    addnav("Spielen", "necron_casino.php?op=highcard&action=play"); 
    } 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach necron","necron.php"); 
...
    if($enough){ 
      addnav("Würfeln", "necron_casino.php?op=slots&action=play&turn=1"); 
    } 
...
        addnav("Weiter", "necron_casino.php?op=slots&action=play&turn=2"); 
...
        addnav("Weiter", "necron_casino.php?op=slots&action=play&turn=3"); 
...
            addnav("Spiel nochmal", "necron_casino.php?op=slots"); 
            $one = 0; 
            $two = 0; 
            $three = 0; 
            $four = 0; 
...
    addnav("Einsatz 10", "necron_casino.php?op=slots&bet=10&turn=1"); 
    addnav("Einsatz 100", "necron_casino.php?op=slots&bet=100&turn=1"); 
    addnav("Einsatz 250", "necron_casino.php?op=slots&bet=250&turn=1"); 
    addnav("Einsatz 500", "necron_casino.php?op=slots&bet=500&turn=1"); 
    addnav("Einsatz 1000", "necron_casino.php?op=slots&bet=1000&turn=1"); 
    } 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach necron","necron.php"); 
...
    { 
        if ($HTTP_GET_VARS[cost] == "pay1" ) redirect("necron_casino.php?op=hut&action=spiel1"); 
        if ($HTTP_GET_VARS[cost] == "pay2" ) redirect("necron_casino.php?op=hut&action=spiel2"); 
        if ($HTTP_GET_VARS[cost] == "pay3" ) redirect("necron_casino.php?op=hut&action=spiel3"); 
    } 
...
    } 
    addnav("Nochmal spielen","necron_casino.php?op=hut"); 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach necron","necron.php"); 
}else{ 
...
    addnav("Wette `^ $cost Gold","necron_casino.php?op=hut&cost=pay1"); 
    addnav("Wette `^ $cost1 Gold","necron_casino.php?op=hut&cost=pay2"); 
    addnav("Wette `^ $cost2 Gold","necron_casino.php?op=hut&cost=pay3"); 
    addnav("oder"); 
    addnav("Anderer Tisch ", "necron_casino.php"); 
    addnav("Zurück nach Necron","necron.php"); 
}} 
