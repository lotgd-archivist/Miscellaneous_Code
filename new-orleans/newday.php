...
Manche Rassen, die besonders mÃ¤chtig sind, sind nur gegen vorherige Absprache mit dem Team gestattet und als solche auch kenntlich gemacht. 
Wer also eine Idee hat, fÃ¼r einen Gott zum Beispiel, setzt sich bitte vor der Erstellung mit uns zusammen. Wir beiÃŸen nicht, keine Sorge :) 
...
Schickt dazu einfach Ã¼ber den Support eine Anfrage mit eurem Charkonzept und eurer Charidee, damit wir einen Eindruck bekommen kÃ¶nnen, dass ihr euch Gedanken gemacht habt und der Char auch durchdacht ist und nicht nur da ist, um sich an der Macht oder Position zu ergÃ¶tzen und wir schauen, dass es passt ;)

<b>Allgemeines zur Rassenwahl</b>
Die aufgefÃ¼hrten Rassen sind diejenigen, welche am hÃ¤ufigsten vertreten sind. Andere Rassen sind aber genauso mÃ¶glich.
In New Orleans (bzw fÃ¼r die Welt unseres Servers) gilt, die Magie und alles was dazu gehÃ¶rt geheim zu halten. Das bedeutet, alle nicht-menschlich ausehenden Wesen sind in die Mythenstadt (Myth Algiers) verbannt. Dort dÃ¼rfen sie sein, was immer sie wollen. Die RÃ¤te der Kontinente kontrollieren die Einhaltung sehr streng (auch Ingame ;) )
Wesen, die ÃœbernatÃ¼rlich sind, aber menschlich Aussehen, dÃ¼rfen frei wÃ¤hlen, ob sie in der Mythenstadt oder New Orleans selbst leben wollen.
Desweiteren mÃ¼ssen Handlungen vor Menschen unterbunden werden, die die Geheimhaltung der Ã¼bernatÃ¼rlichen Welt gefÃ¤hrden, nÃ¤heres erfahrt ihr in den Regeln des Rates.

<b>StÃ¤rkeverhÃ¤ltnisse</b>
Wie Ã¼berall gibt es stÃ¤rkere und schwÃ¤chere Wesen und auch hier mÃ¶chten wir sicherstellen, dass es nicht zu Unklarheiten kommt.
(Im Folgenden werden Beispiele genannt, die stellvertretend fÃ¼r alle normalen oder speziellen Rassen gelten! Wird bei Bedarf erweitert.)

&raquo;   Am SchwÃ¤chsten sind bekanntlich die einfachen <b>Menschen</b>, die Ã¼ber keinerlei magischen FÃ¤higkeiten verfÃ¼gen.
&raquo;   MenschenÃ¤hnliche Wesen wie <b>Feen</b>, sind nicht besonders Stark, verfÃ¼gen aber oft Ã¼ber magische KrÃ¤fte.
&raquo;   <b>Menschliche Spezialeinheiten</b> sind je nach ihrer Ausbildungsrichtung einem normalen, Ã¼bernatÃ¼rlichen Wesen ebenbÃ¼rtig.
&raquo;   Ein normaler <b>Hybrid oder DÃ¤mon etc</b> wird einem einfachen Vampir etc. normalerweise Ã¼berlegen sein.
&raquo;   <b>Elitekrieger</b> sind deutlich mÃ¤chtiger als ihre normalen Verwandten.
&raquo;   <b>RudelfÃ¼hrer, Ã„lteste</b> etc. Ã¼bersteigen die Elitekrieger um einiges.
&raquo;   <b>Die Hand des Rates</b> besitzen besondere FÃ¤higkeiten, um auch Elitekrieger und Ã„lteste in ihre Schranken weisen zu kÃ¶nnen 
(doch dÃ¼rfen sie nicht ohne triftigen Grund von diesen FÃ¤higkeiten gebrauch machen).
&raquo;   <b>UrWesen und hochrangige DÃ¤monen etc.</b> besitzen ungeheure KrÃ¤fte und kommen (zum GlÃ¼ck) nur sehr, sehr selten vor.
...
    Von Andras fÃ¼r New Orleans */
elseif($session['user']['is_plot_char'] == 0)
{
    if ($_GET['set_plot'] === NULL)
    {
        page_header('Plot-Char?');
        
        output('`7Hier geht es darum, ob Du einen Plot-Char spielen willst. Plot Chars nehmen aktiv am Serverplot teil und helfen, diesen weiterzufÃ¼hren und Ã¼ber die Zeit stetig weiter zu entwickeln. `n
                DafÃ¼r sollten sie sich jedoch an einige Vorgaben orientieren, damit das Wissen der Spieler gleich ist und nicht zwei unterschiedliche Sichten und Konzepte aufeinander prallen. Schau Dir am besten erst einmal an, ob Dir die Konzepte
                zu den Hauptrassen im Plot zusagen, falls Du eine von diesen spielen willst. Falls Du z.B. lieber einen Vampir oder Werwolf nach deinen eigenen Vorstellungen gestalten willst, dann wÃ¤hle "Nein". `n
...
                WÃ¤hlst du "Nein" aus, wissen deine Mitspieler, dass dein Char anders konstruiert und erdacht wurde und von der Servernorm abweichen kann. `n`n
                `n
...
        addnav('NÃ¶Ã¶Ã¶Ã¶!', 'newday.php?set_plot=1'.$resline);
        
...
            output("`n`c`9Es herrscht bereits geschÃ¤ftiges Treiben auf den StraÃŸen von New Orleans und auf den Stadt- und MarktplÃ¤tzen bieten die HÃ¤ndler ihre Waren feil.`0`c");
        }else if(getgametime() >= "12:00" AND getgametime() < "15:00"){
            output("`c<font size='+4'>`b`rEs ist Mittagsstunde!`0`b</font>`c",true);
            output("`n`c`9Die Sonne steht am hÃ¶chsten Punkt und erhellt die schÃ¶ne Stadt New Orleans. Vielleicht wÃ¤re es an der Zeit das Mittagsmahl einzunehmen?`0`c");
...
            output("`n`c`9Die Nacht ist Ã¼ber New Orleans hereingebrochen, langsam leeren sich die StraÃŸen und die HÃ¤user und Schenken fÃ¼llen sich. Sei auf der Hut! Die Dunkelheit Ã¶ffnet nicht nur den schÃ¶nen Dingen ihre Pforten, auch die dunklen Kreaturen erwachen.`0`c");
        }
...
                            $turnsperday += 30;
                            output('`c`@Du Ã¶ffnest den Beutel und findest `^4000 `@Erfahrungspunkte und WaldkÃ¤mpfe.`n`bFrohe Weihnachten wÃ¼nscht das Team von New Orleans.`c`b`n`n');
                            break;
                            }
                        case 2:
...
                            $turnsperday += 30;
                            output('`c`@Du Ã¶ffnest den Beutel und findest `^40000 `@GoldstÃ¼cke und WaldkÃ¤mpfe.`n`bFrohe Weihnachten wÃ¼nscht das Team von New Orleans.`c`b`n`n');
                            break;
                            }
                        case 3:
...
                            $turnsperday += 30;
                            output('`c`@Du Ã¶ffnest den Beutel und findest `^15 `@Edelsteine und WaldkÃ¤mpfe.`n`bFrohe Weihnachten wÃ¼nscht das Team von New Orleans.`c`b`n`n');
                            break;
                            }
                        case 4:
...
                        $turnsperday += 30;
                        output('`c`@Du Ã¶ffnest den Beutel und findest je `^3 `@Angriffs- und Verteidigungspunkte, sowie WaldkÃ¤mpfe.`n`bFrohe Weihnachten wÃ¼nscht das Team von New Orleans.`c`b`n`n');
                        break;
                        case 5:
                        $session['user']['deathpower'] += 200;
                        $turnsperday += 30;
                        output('`c`@Du Ã¶ffnest den Beutel und findest `^200 `@Gefallen und WaldkÃ¤mpfe.`n`bFrohe Weihnachten wÃ¼nscht das Team von New Orleans.`c`b`n`n');
                        break;
                        }
                    break;
                    default:
