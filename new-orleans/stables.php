...
$sql = "SELECT mountname,mountid,mountcategory,dkreq FROM mounts WHERE mountactive=1 ORDER BY mountcategory,mountcostgems,mountcostgold";
$result = db_query($sql);
$category="";
...
    
    
    if($session['user']['dragonkills'] >= $row['dkreq'])
...
viewcommentary("Staelle","Unterhalte dich mit Käufern und Händlern:`n`n");
