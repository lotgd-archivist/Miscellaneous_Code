...
            }else{ 
                output("\"`GMeein Sooohn, was stööörst Du meiiiineee Ruuuuuheeee? 
                        Haabeenn Diir dieee Waarnungennn niiicht gerreicht? Muusssteeest Duu uuunbeeeddinngt meeiiiinee Ruuheee 
...
                switch(e_rand(1,5)){ 
                        case 1: 
                        output("trifft Dich mitten im Gesicht, so dass eine hässliche Narbe entstanden ist. Die Wucht 
...
        output("`@`b`cOld Drawls Stammtisch`c`b`0`n`n"); 
        output("`@Du siehst, wie die Leute in der Kneipe immer wieder misstrauisch auf einen Tisch in der Ecke 
                der Kneipe blicken und sich leise über einen alten Mann unterhalten. Im Lärm der Kneipe 
                verstehst Du immer nur Wortfetzen aus den Gesprächen, aber daraus geht für Dich hervor, dass 
...
                Mann ein Geheimnis zu verbergen und Dein Gefühl sagt Dir, dass es Dir irgendwie nützlich sein kann 
