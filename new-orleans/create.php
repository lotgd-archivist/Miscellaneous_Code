...
<div align=justify><font color=#A26844>
...
Die Regeln in der Stadt New Orleans dienen ihren Bewohnern zur <i>Orientierung und Information</i> und müssen von jedem Spieler selbstständig gelesen werden!
...
<br><br>
<font color=#A26844>1. Auf diesem Server sind <b>alle</b> Arten und Vorstellungen von Chars erlaubt, die in die Moderne passen. Egal ob Dämon, Mensch, Metawesen, Mutant, Märchenwesen, oder was euch sonst so einfällt. Lasst eurer Kreativität und Wünschen freien Lauf, solange existierende Geschichten (Filme, Bücher, etc.) nicht nachgespielt oder kopiert werden.<br>
...
3. Trage bitte im entsprechenden Feld deiner Bio den Künstler/Person deines Avatars ein. Diesen brauchen wir, um zu kontrollieren, ob der Avatar
...
10. Umbenennungen sind in New Orleans (selbstständig) möglich, erfolgen jedoch nur, wenn bereits <i>die neue Biografie samt Avatar eingefügt ist</i>.<br>
...
16. Nutzer haften selbst für eingestellte Inhalte jedweder Art. New-Orleans ist  nicht für entstandene (Urheber-)Rechtsverletzungen haftbar.
</font>
<br><br><br>
...
handelt. Auch Markennamen und Sonderzeichen sind verboten. Ausnahme bildet das ´ -Zeichen, wenn ihr einen Apostroph im Namen habt. Punkte und Bindestriche sind im Rahmen der Namen erlaubt.<br>
2. Sieh von Titeln wie Gott, Kaiser, etc ab, um sie den Serverplotspielern auf dem Server zu lassen. Sprich uns also an, wenn du einen solchen Char mit Titel haben möchtest.<br>
...
4b. In der Bio und dem OOC ist Musik erlaubt, solange kein Video eingebettet ist und die Musik <b>nicht</b> automatisch abspielt. <br> 
...
<br><br>
<font color=#A26844>
1. Das Lesen der <b>Rasseninfo</b> und der <b>Story</b> ist <b>erwünscht</b>! Wir erhoffen uns ein einheitliches Spiel :) <br>
...
5. Beachtet bitte die Machtverhältnisse! Natürlich kannst du dich mit deinem Partner absprechen.<br>
...
9. Inspiration ist bei uns gern gesehen, egal ob Film/Serien/Buch/Computerspielcharakter. Du kannst spielen, was du willst.<br>
10. In New Orleans gibt es allgemeine Rassenansichten zu den Hauptrassen. Diese zeigen dir, wie wir diese Rassen sehen und wie die anderen Spieler deinen Char wahrnehmen. Wenn du deine eigene Ansicht spielen magst, darfst du das natürlich tun, sei dir nur über die Unterschiede zum Server bewusst.
</font>
<br><br>
...
<input type='checkbox' name='read' value='1'>`^`iIch habe die Regeln gelesen, verstanden und Akzeptiere diese und bestätige, dass ich das 16. Lebensjahr bereits vollendet habe.`i`&`n`n
