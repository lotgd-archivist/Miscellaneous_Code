...
if ($HTTP_GET_VARS[op]=="fight" || $HTTP_GET_VARS[op]=="run"){
    if ($_GET['op']=="run"){
        if (e_rand(0,2)==1) {
            output("`\$Niva`) verflucht dich für deine Feigheit.`n`n");
            $favor = 5 + e_rand(0, $session['user']['level']);
            if ($favor > $session['user']['deathpower'])
                $favor = $session['user']['deathpower'];
            if ($favor > 0) {
                output("`)Du hast `^$favor`) Gefallen bei `\$Niva VERLOREN`).");
...
if ($battle){
    ...
    if ($victory) {
        ...
        output("`#Du bekommst `^{$badguy['creatureexp']}`# Gefallen bei `\$Niva`#!`n`0");
...
if ($_GET['op']==""){
    ...
    Auf der Gedenktafel über der Tür ist zu lesen: `\$Niva, Herrin über den Tod`).");
...
//    output("You enter the mausoleum and find yourself in a cold marble chamber.  no don't type that it's distracting.  Can't think, too much typing, stop, stoooppppp.  Now why couldn't you type verbatim a minute ago.  Ugh, sonofabitch.  The air is so, no the air is dammit.  The air within the chamber chils you to the bone?  You don't have bones, shit.  What'd I say before? Ugh.  Hahahaha. hahaha.  Hiccup.  Hiccup.  Hiccup.  Stop it, you're gonna kill me, stop stop!  Shit I forget what we actually stop that!  dammit.  Ok, you enter the mausoleum, and find yourself in a cold stark marble chamber.  The air surrounding you is chilled, no, is, the air around you carries the chill of death itself.  From the darkness two black eyes seem to stare in to your soul.  Within your mind you hear (dramatic pause) Whahahaha.  Within your mind you hear YOUR MOM.  That's what he would say.  Ok, within your mind you hear.  Ugh.  How are you gonna pick out the good crap in this, I mean, if I just keep talking, will you really just keep typing it?  Crap, you wrapped around, I didn't even know you could do that.  All right, where did we stop at ? Within something.  Within your mind you hear.  Within your mind a deep voice, no, um, a deep voice penetrates your mind.  Period.  Now whatever Niva says.  What's he say, what'd you have him say before?  I am Niva, your mom.  Why have you come here, no, I know no, allright, lemme think.  Ok, this'll be like text, so I don't know if it will be in those quotation mark things.  Allright.  Your mortal coil has forsaken you.  Now you turn to me.  To prove your worth in death go out amongst the ugh.  Go out amongst the... We need a word for, cause the other things are clearly dead, go out amongst.  Hmm.  Meow.  Don't type that.  Ugh, hehehe.  hahahaha.  Stop it, you're gonna, stop it.  all right.  Go out and find those that have eluded my grasp.  Send their souls where yours has gone.  Then return to me to seek the favor you, no, to fi-- no.  And return to me, and I shall reward you well.  Period.  Oh well, yeah, you already put a period.  Holy crap, you wrapped around a second time?  Hehehehe.  Well.  I think at this point, we need to go through and get rid of all the crap that you typed and you didn't need to type.  I'm gonna talk so fast that you can't hj.  Bjwuhehe.  Bwahahaha.  Choahaha.  Heh, you ass.  I'm done, I don't have anything else to say.  Ugh.  I'm gonna go check my swimming skill.  Aah, look, I'm 95, I'm done.  Alright, I'm gonna go camp.  Are you still freaking typing what I'm saying?  ugh.  I am a stupid moron.  I have the ass of a flaming monkey.  Hehe.  I'm the one who ate the fart.  Look at you, look at the things you're typing.  No, cause I clearly said Choo, See eightch Ooh Ooh.  See eitch Ooh Ooh, what? I didn't say that.  Hehhehehehe.  Huh.  (evil glare)");
    ...
    Aus der Dunkelheit starren zwei schwarze Augen direkt in deine Seele. Ein feuchtkalter Griff scheint deine Seele zu umklammern und sie mit den Worten der Todesgöttin `\$Niva`) höchstpersönlich zu erfüllen.`n`n
    ...
    addnav("Frage Niva nach dem Wert deiner Seele","graveyard.php?op=question");
    ...
    if ($session['user']['soulpoints']<$max){
        if ($session['user']['deathpower']>=$favortoheal){
            output("`\$Niva`) nennt dich einen Schwächling, weil du nach Wiederherstellung deiner Seele fragst. Aber da du genug Gefallen bei ihm gut hast, gibt er deiner Bitte zum Preis von `4$favortoheal`) Gefallen nach.");
            $session['user']['deathpower']-=$favortoheal;
            $session['user']['soulpoints']=$max;
        }else{
            output("`\$Niva`) verflucht dich und wirft dich aus dem Mausoleum. Du mußt ihm erst genug Gefallen getan haben, bevor er dir die Wiederherstellung deiner Seele gewährt.");
        }
    }else{
        output("`\$Niva`) seufzt und murmelt etwas von \"`7Nur weil sie tot sind, heißt das doch nicht, dass sie nicht zu denken brauchen, oder?`)\"`n`n");
    ...
    if ($session['user']['deathpower']>=100) {
        output("`\$Niva`) spricht: \"`7Du hast mich tatsächlich beeindruckt. Ich sollte dir die Möglichkeit gewähren, deine Feinde in der Welt der Sterblichen zu besuchen.`)\"");
        addnav("Nivas Gefallen");
        ...
        output("`\$Niva`) spricht: \"`7Ich bin nicht wirklich beeindruckt von deinen Bemühungen, aber einen kleinen Gefallen werde ich dir gewähren. Führe meine Arbeit fort und ich kann dir vielleicht mehr meiner Kraft anbieten.`)\""); 
        addnav("Mivas Gefallen");
        addnav("h?Feind heimsuchen (25 Gefallen)","graveyard.php?op=haunt");
        addnav("Wiederbelebunug zum RP (10 Gefallen)","rpresurect.php");
        addnav("Sonstiges");
    }else{
        output("`\$Niva`) spricht: \"`7Ich bin von deinen Bemühungen noch nicht beeindruckt. Führe meine Arbeit fort und wir können weiter reden.`)\"");
    ...
    output("`n`nDu hast `6{$session['user']['deathpower']}`) Gefallen bei `\$Niva`).");
    addnav("Frage Niva nach dem Wert deiner Seele","graveyard.php?op=question");
    addnav("S?Seele wiederherstellen ($favortoheal Gefallen)","graveyard.php?op=restore");
    
    addnav("Zurück zum Friedhof","graveyard.php");
}elseif ($_GET['op']=="dona"){
    output("`\$Nivas`)' Gelächter lässt den Boden erbeben. \"`7Du verzichtest für ein paar Punkte auf das Leben? Bitte, soll mir nur Recht sein.`)\" Mit diesen Worten gibt er deiner Bitte nach.`nDu bekommst 5 Donationpoints.");
    ...
    output("`\$Niva`) raunzt dir genervt entgegen, dass du noch `^".date("G\\h, i\\m, s\\s",strtotime("1980-01-01 00:00:00 + $realsecstotomorrow seconds"))."`) hier bleiben musst, wenn du nicht weiter für ihn arbeiten willst.");
    $session['user']['deathpower']-=1;
    addnav("Zurück zum Mausoleum","graveyard.php?op=enter");
    addnav("Zurück zum Friedhof","graveyard.php");
}elseif ($_GET['op']=="haunt"){
    output("`\$Niva`)  ist von deinen Aktionen beeindruckt und gewährt dir die Macht, einen Feind heimzusuchen.`n`n");
    ...
    $string="%";
    for ($x=0;$x<mb_strlen($_POST['name']);$x++){
        $string .= mb_substr($_POST['name'],$x,1)."%";
    }
    $sql = "SELECT login,name,level FROM accounts WHERE name LIKE '".addslashes($string)."' AND locked=0 ORDER BY level,login";
    $result = db_query($sql);
    if (db_num_rows($result)<=0){
        output("`\$Niva`)  kann niemanden mit einem solchen Namen finden.");
    }elseif(db_num_rows($result)>100){
        output("`\$Niva`) denkt, du solltest die Zahl derer, die du heimsuchen willst, etwas einschränken.");
        output("<form action='graveyard.php?op=haunt2' method='POST'>",true);
        addnav("","graveyard.php?op=haunt2");
        output("Wen willst du heimsuchen? <input name='name' id='name'> <input type='submit' class='button' value='Suchen'>",true);
        output("</form>",true);
        ...
        output("`\$Niva`) wird dir gestatten, eine der folgenden Personen heimzusuchen:`n");
        output("<table cellpadding='3' cellspacing='0' border='0'>",true);
        output("<tr class='trhead'><td>Name</td><td>Level</td></tr>",true);
        for ($i=0;$i<db_num_rows($result);$i++){
            $row = db_fetch_assoc($result);
            output("<tr class='".($i%2?"trlight":"trdark")."'><td><a href='graveyard.php?op=haunt3&name=".HTMLSpecialChars($row['login'])."'>",true);
            output($row['name']);
            output("</a></td><td>",true);
            output($row['level']);
            output("</td></tr>",true);
            addnav("","graveyard.php?op=haunt3&name=".HTMLSpecialChars($row['login']));
        }
        output("</table>",true);
    }
    addnav("Frage Niva nach dem Wert deiner Seele","graveyard.php?op=question");
    ...
    if (db_num_rows($result)>0){
        ...
        output("`\$Niva`) kann sich nicht mehr auf diese Person konzentrieren. Du kannst sie jetzt nicht heimsuchen.");
    }
    addnav("Frage Niva nach dem Wert deiner Seele","graveyard.php?op=question");
    addnav("S?Seele wiederherstellen ($favortoheal Gefallen)","graveyard.php?op=restore");
    addnav("M?Zurück zum Mausoleum","graveyard.php?op=enter");
