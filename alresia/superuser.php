...
if ($_GET[op]=="commentdelete"){
    ...
    $return = preg_replace("'[?&]c=[[:digit:]-]*'","",$return);
    $return = mb_substr($return,mb_strrpos($return,"/")+1);
    if (mb_strpos($return,"?")===false && mb_strpos($return,"&")!==false){
        $x = mb_strpos($return,"&");
...
if ($_GET[op]=="checkcommentary"){
    ...
    addnav("User freischalten","registratur.php");
    ...
    addnav("Rasseneditor","raceeditor.php");
    addnav("Wortfilter","badword.php");
    addnav("Bibliothekar","sulib.php");
    addnav("Zeitung","redaktion.php");
    addnav("Waisenkinder-Editor","waiseneditor.php");

    addnav("Mechanik");
    if ($session[user][superuser]>=3) addnav("Spieleinstellungen","configuration.php");
    addnav("Hausmeister","suhouses.php");
    addnav("Hausmeister Essos","suhouses2.php");
    addnav("Haussetup `mNuvola","nhmaster.php");
    addnav("Haussetup `4Essos","nhmaster2.php");
    addnav("Haussetup `*Silanna","nhmaster3.php");
    addnav("Haussetup `!Ordamant","nhmaster4.php");
