...
//    if ($session[user][gold]>$cost){ // Eric Stevens
    ...
    $sql="SELECT name FROM accounts WHERE locked=0 AND loggedin=1 AND alive=0 AND laston>'".date("Y-m-d H:i:s",strtotime(date("r")."-".getsetting("LOGINTIMEOUT",4900)." seconds"))."' ORDER BY login ASC"; 
